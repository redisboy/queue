...
import com.suntendy.queue.employee.util.upload.File;
import com.suntendy.queue.employee.util.upload.SmartUpload;
...
public class UpLoadUserHeadImage extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			response.sendRedirect("/ZoomImageDemo/uploadimage.jsp?Picurl="
					+ FileName + "&step=2");
		} catch (Exception e) {
			e.printStackTrace();
		}
