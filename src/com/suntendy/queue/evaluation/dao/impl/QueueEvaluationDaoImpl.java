...
public class QueueEvaluationDaoImpl extends BaseDao<QueueEvaluation, Integer>  implements IQueueEvaluationDao {

	public List<QueueEvaluation> getQueueEvaluate(String tjms, String ksrq,
