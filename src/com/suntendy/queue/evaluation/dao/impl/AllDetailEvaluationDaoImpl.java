...
public class AllDetailEvaluationDaoImpl extends BaseDao<AllDetail, Integer>  implements IAllDetailEvaluationDao {

	public List<AllDetail> getAllDetailEvaluation(String tjms, String ksrq,
			String jsrq,String jbr,String code,String deptCode,String deptHall) throws Exception   {
		if (tjms.equals("0")) {
			if (ksrq != "" && jsrq != "") {
		...
		String[] properties = { "ksrq", "jsrq" ,"jbr","code","deptCode","deptHall"};
		String[] propertyValues = { ksrq, jsrq,jbr ,code, deptCode, deptHall};
