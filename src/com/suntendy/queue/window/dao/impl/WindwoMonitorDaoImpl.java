...
public class WindwoMonitorDaoImpl  extends BaseDao<WindowMonitor, Integer>  implements IWindowMonitorDao {
...
//				jsrq = "to_date('" + jsrq + " 23:59:59','yyyy-mm-dd hh24:mi:ss')";
		...
		String[] properties = { "ksrq", "jsrq" ,"deptCode","deptHall","barid","xm"};
		String[] propertyValues = { ksrq, jsrq,deptCode,deptHall,barid,xm };
