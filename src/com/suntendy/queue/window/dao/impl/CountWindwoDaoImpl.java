...
public class CountWindwoDaoImpl  extends BaseDao<WindowCount, Integer>  implements ICountWindowDao {

	public List<WindowCount> getWindowCount(String tjms, String ksrq, String jsrq,String deptCode,String deptHall,String barid) throws Exception {
		if (tjms.equals("0")) {
			if (ksrq != "" && jsrq != "") {
...
//				jsrq = "to_date('" + jsrq + " 23:59:59','yyyy-mm-dd hh24:mi:ss')";
		...
		String[] properties = { "ksrq", "jsrq" ,"deptCode","deptHall","barid"};
		String[] propertyValues = { ksrq, jsrq,deptCode,deptHall,barid };
