 ...
 * 代理人排队统计
 */
public class AgentPdCountAction extends BaseAction {
	private static final long serialVersionUID = 1L;
	private IAgentPdCountService agentPdCountService;
	...
	public IAgentPdCountService getAgentPdCountService() {
		return agentPdCountService;
	}

	public void setAgentPdCountService(IAgentPdCountService agentPdCountService) {
		this.agentPdCountService = agentPdCountService;
	}

	public String agentPdCount() throws Exception {
		...
		List<AgentPdCount> list = agentPdCountService.agentPdCount(ksrq, jsrq, tjms,deptCode,"");
