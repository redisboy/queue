...
public class AgentPdCountDaoImpl extends BaseDao<AgentPdCount, Integer> implements IAgentPdCountDao {

	public List<AgentPdCount> agentPdCount(String ksrq, String jsrq, String tjms,String deptCode, String deptHall) throws Exception {
