...
public class AgentWaitCountDaoImpl extends BaseDao<AgentWaitCount,Integer> implements IAgentWaitCountDao  {

	public List<AgentWaitCount> agentCount(String ksrq,String jsrq,String tjms,String deptCode, String deptHall) throws Exception {
		if (tjms.equals("0")) {
			if (ksrq != "" && jsrq != "") {
		...
		List<AgentWaitCount> list=this.findByMap(properties, propertyValues, "", "", BaseDao.SELECTBYMAP);
		return list;
	}
