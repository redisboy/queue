...
public class EmployeeWaitCountDaoImpl extends BaseDao<EmployeeWaitCount, Integer> implements IEmployeeWaitCountDao{
...
//				jsrq = "to_date('" + jsrq + " 23:59:59','yyyy-mm-dd hh24:mi:ss')";
	...
	public List<EmployeeWaitCount> employeeCount() throws Exception {
		...
		return this.findByMap(properties, propertyValues, "", "", "employeeCount");
	}
