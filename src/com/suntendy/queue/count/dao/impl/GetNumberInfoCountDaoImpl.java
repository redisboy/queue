...
public class GetNumberInfoCountDaoImpl extends BaseDao<GetNumberInfoCount, Integer> implements IGetNumberInfoCountDao{

	public List<GetNumberInfoCount> getNumberInfoCount(String tjms, String ksrq, String jsrq,String deptCode,String deptHall,String xm) throws Exception {
		...
		String[] properties = { "ksrq", "jsrq" ,"deptCode","deptHall","xm"};
		String[] propertyValues = { ksrq, jsrq,deptCode,deptHall,xm };
	...
	public List<GetNumberInfoCount> getDoubleNumberInfo() throws Exception{
		return this.findByMap(null, null, "", "", "getDoubleNumber");
	}
	/**
	 * 取号信息预警详情
	 * @return
	...
	public List<GetNumberInfoCount> getDetailDoubleNumber(String idnumber) throws Exception {
		...
		return this.findByMap(properties, propertyValues, "", "", "getDetailDoubleNumber");
	}
}