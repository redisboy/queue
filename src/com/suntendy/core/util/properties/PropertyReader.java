package com.suntendy.core.util.properties;
...
public class PropertyReader {
	...
	private static final Log _log = LogFactory.getLog(PropertyReader.class);
	 ...
	 * @since wapportal_manager version(2.0)
	 */
	public final static boolean setValueAndStore(String propertyFilePath,Hashtable htKeyValue) {
	 ...
	 * @since wapportal_manager version(2.0)
	 */
	public final static boolean setValueAndStore(String propertyFilePath,Hashtable htKeyValue, String storeMsg) {
		Properties ppts = getProperties(propertyFilePath);
	 ...
	 * @since wapportal_manager version(2.0)
	 */
	public final static boolean createPropertiesFile(String propertyFilePath,Hashtable htKeyValue) {
	 ...
	 * @since wapportal_manager version(2.0)
	 */
	public final static boolean batchUpdateValue(String propertyFilePath,Hashtable htKeyValue) {
