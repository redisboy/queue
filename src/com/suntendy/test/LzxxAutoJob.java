...
*/
public class LzxxAutoJob extends StatefulMethodInvokingJob {

	private Logger logger = Logger.getLogger(this.getClass().getName());
	
	protected void executeInternal(JobExecutionContext context) throws JobExecutionException {
		
		AutoSendLzxxAction autoSendLzxxAction = (AutoSendLzxxAction) SystemAction.getBean("autoSendLzxxAction");
		...
		try {
			...
			autoSendLzxxAction.autoSendLzxx();
