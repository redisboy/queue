...
*/
public class TestJob extends StatefulMethodInvokingJob {

	private Logger logger = Logger.getLogger(this.getClass().getName());
	
	protected void executeInternal(JobExecutionContext context) throws JobExecutionException {
		
		LzxxAction lzxxAction = (LzxxAction) SystemAction.getBean("lzxxAction");
		...
		try {
			...
			System.out.println("--------------定时任务----------" + new Date() + "开始查询领证信息信息");
			lzxxAction.run();
