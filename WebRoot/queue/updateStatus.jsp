  ...
  <body>
   		<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
			...
			<tr>
				...
				<td height="51" valign="middle" background="images/t-2.jpg">
					<span style="font-family: '黑体', '宋体'; font-size: 18px; color: #fff; padding-left: 15px; letter-spacing: 10px; letter-spacing: 10px;">异常数据处理</span>
				</td>
	...
	<script type="text/javascript">
		function upStatus(){
			...
			form1.action = "callout/updateCalloutStatus.action";
			form1.submit();
		}
	</script>
</html>