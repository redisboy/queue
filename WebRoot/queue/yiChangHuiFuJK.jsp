...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>异常数据恢复(接口)(根据6合1库更改本地)</title>
  ...
  <body>
   		<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
			...
			<tr>
				...
				<td height="51" valign="middle" background="images/t-2.jpg">
					<span style="font-family: '黑体', '宋体'; font-size: 18px; color: #fff; padding-left: 15px; letter-spacing: 10px; letter-spacing: 10px;">异常数据恢复(通过接口同步数据)</span>
				</td>
			...
			<tr>
				...
				<td height="100" style="text-align: center" valign="middle" bgcolor="#f7f7f7">
					...
					<input name="bt2" class="button" type="button" value="缓存重置" onClick="upStatusDH()" >
					<br><br><br><br>
					<table id="myTable" width="60%" border="0" cellpadding="1" cellspacing="1" class="table_back">
							<tr>
				    			<td width="30%" height="35" bgcolor="#FFFFFF" class="tableheader1">员工编号：</td>
				    			<td width="70%" height="35" bgcolor="#F1F9FD">&nbsp;
				    				<input name="ygbh" id="ygbh" style="width: 300px;text-transform: uppercase" />
				    			</td>
				    		</tr>
						</table>
						<br>
						<input name="bt1" class="button" type="button" value="确定" onClick="upStatusYGBH()" />
					</form>
					<br>
				</td>
	...
	<script type="text/javascript">
		function upStatus(){
			...
			form1.action = "callout/yiChangJKCL.action?sjhm="+sjhm;
			form1.submit();
		}
		function upStatusDH(){
			var sjhm = $("#sjhm").val();
