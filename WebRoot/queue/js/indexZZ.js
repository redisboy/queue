...
GenerateNumber = (function() {
    ...
    var mainType = "<li style='margin-top:30px'><a href='javascript:void(0);' class='btn_ywlx' onfocus='this.blur()' onclick='gn.showChildType(\"01\")'>机动车<a></li>"
    	+ "<li style='margin-top:30px'><a href='javascript:void(0);' class='btn_ywlx' onfocus='this.blur()' onclick='gn.showChildType(\"02\")'>驾驶人<a></li>"
    	+ "<li style='margin-top:30px'><a href='javascript:void(0);' class='btn_ywlx' onfocus='this.blur()' onclick='gn.showChildType(\"04\")'>违法<a></li>";
			...
			$.ajax({type: "POST", cache: false,data: "9", async: false, dataType: "text",
			        ...
			        success: function(data) {
			            if (data != null || data !="") {
							...
							var ts = new Date(); 
							var ss = parseInt(ts / 1000 % 60, 10)+6;
							var timer= window.setInterval(function(){
								$("#timers").css("display", "");
								document.getElementById("timers").innerHTML = "请将二代身份证放置识读区"+"<span class='time_js'>"+(ss-(parseInt(new Date() / 1000 % 60, 10)))+"</span>";
							 },1000);
							var nRet = "";
...
//								window.alert("未放置身份证或身份无效");
								clearInterval(timer);
//								$("#timers").css("display", "none");
								$("#timers").html ="未正确放置二代身份证或二代身份证无效";
								}},5000);
					} else {
