...
GenerateNumber = (function() {
    ...
    var SFZnumber="",SFZNameA="",SFZSex="",SFZNation="",SFZBorn="",SFZAddress="",SFZPolice="",SFZUserLifeB="",SFZUserLifeE="",SFZBase64="",DYnumber="",DYname="";
...
//						window.setTimeout("$('#page1').remove()", 1000);
						var features = "status=no,resizable=no,top=0,left=0,scrollbars=no"
															+ "titlebar=no,menubar=no,location=no,toolbar=no,z-look=yes"
										window.open("idCardPrintWeiFang.jsp?nameA="+encodeURIComponent(encodeURIComponent(SFZNameA,'utf-8'))+"&number="+SFZnumber+
											"&Sex="+SFZSex+"&Nation="+SFZNation+"&Born="+SFZBorn+"&Address="+encodeURIComponent(encodeURIComponent(SFZAddress,'utf-8'))
											+"&Police="+encodeURIComponent(encodeURIComponent(SFZPolice,'utf-8'))+"&UserLifeB="+SFZUserLifeB
											+"&UserLifeE="+SFZUserLifeE+"&queueName="+encodeURIComponent(encodeURIComponent(data.queueName,'utf-8'))
											+"&count="+count+"&serialNum="+data.serialNum+"&DYname="+encodeURIComponent(encodeURIComponent(DYname,'utf-8'))
											+"&IDNumber="+IDNumber+"&peoNum="+data.peoNum, "_blank", features);
