...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td height="51" valign="middle"  background="/queue/images/t-2.jpg">
    	<span style="font-family:'黑体', '宋体';font-size:18px; color:#fff;padding-left:15px;letter-spacing: 10px;letter-spacing: 10px;">提示信息设置</span>
    </td>
  ...
  <tr>
	...
	<input name="button" type="button" class="button" value="添加" onClick="addNWindow()"/><br/><br/>
    <table width="98%" align="center" border="0" cellpadding="0" cellspacing="0" >
	<tr>
	<td> 
		<ec:table items="nWindowList" var="list" 
					action="nextwindow/NWindowList.action"
					editable="false" 
					width="100%" 
					listWidth="100%"
					classic="true"
				...
				<ec:row style="text-align:center">
				    ...
				    <ec:column width="15%" property="dmsm1" title="业务类型" style="text-align:center" editable="false" />
				    <ec:column width="20%" property="ywmc" title="业务原因" style="text-align:center" editable="false" />
					<ec:column property="nextwindowval" title="提示信息" style="text-align:center" editable="false" />
...
<script type="text/javascript">
	function addNWindow(){
		document.form1.action = "toAddNWindow.action"; 
		document.form1.submit();

	}
	
	function updateNWindow(id){
		document.form1.action = "queryById.action?id="+id;
		document.form1.submit();
	}
	
	function delNWindow(id){
		if(confirm("确定删除吗?")){ 
			document.form1.action = "deleteById.action?id="+id;
			document.form1.submit();
		}
	}
</script>
