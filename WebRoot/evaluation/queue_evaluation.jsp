...
<%
	List<QueueEvaluation> list = (List<QueueEvaluation>) request.getAttribute("list");
	...
	%>
		window.onload=function(){
			...
			for (QueueEvaluation count : list) {
			...
			<%}%>
			var strXML = "<chart xAxisName='' yAxisName='' caption='队列评价统计' showToolTip='0' shownames='1' showvalues='1' showSum='1' useRoundEdges='1'>";
...
function query() { 
	...
	document.form1.action = "dlpjtj.action";
	document.form1.submit();
}
function hpExport(obj){
	window.location.href="/queue/evaluation/queue_evaluation_Export_excel.jsp";
    return true;
}
...
function moveInTdLight(object){
	...
	//判断childlength=11为管理部门+大厅, 10为大厅 
	if(childlength==11){
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td height="51" valign="middle"  background="/queue/images/t-2.jpg">
    	<span style="font-family:'黑体', '宋体';font-size:18px; color:#fff;padding-left:15px;letter-spacing: 10px;letter-spacing: 10px;">队列评价统计</span>
    </td>
    		...
    		<table id="ec_table" class="tableRegion" width="98%" align="center" border="0" cellpadding="0" cellspacing="0">
	    		<thead id="ec_table_head">
	    			<tr>
	    				...
	    				<td valign="middle" style="text-align:center"  width="10%" class="tableHeader" onmouseover="ECSideUtil.lightHeader(this,'ec');" onmouseout="ECSideUtil.unlightHeader(this,'ec');"><div class="headerTitle" >队列名称</div></td>
	    				<td valign="middle" style="text-align:center"  width="10%" class="tableHeader" onmouseover="ECSideUtil.lightHeader(this,'ec');" onmouseout="ECSideUtil.unlightHeader(this,'ec');"><div class="headerTitle" >队列编号</div></td>
	    			...
	    			<c:forEach items="${list}" var="item" varStatus="status">
	    				<c:if test="${(status.index%2)!=0}">
	    					<tr  style="text-align:center">
		    					...
		    					<td class="even" style="text-align:center"  width="10%" onmouseover="moveInTdLight(this)" onmouseout="moveOutTdUnLight(this)">${item.a4}</td>
		    			...
		    			<c:if test="${(status.index%2)==0}">
	    					<tr  style="text-align:center">
		    					...
		    					<td class="odd" style="text-align:center"  width="10%" onmouseover="moveInTdLight(this)" onmouseout="moveOutTdUnLight(this)">${item.a4}</td>
				...
				<td> 
					<ec:table items="list" var="list" 
							...
							<ec:row style="text-align:center">
								<ec:column width="8%" property="name" title="队列名称" style="text-align:center" editable="false" />
								<ec:column width="8%" property="code" title="队列编号" style="text-align:center" editable="false" />
								...
								<ec:column width="8%" property="a4" title="不满意" style="text-align:center" editable="false" />
								<ec:column width="8%" property="countall" title="次数(合计)" style="text-align:center" editable="false" />				
								<ec:column width="8%" property="sumcore" title="总分" style="text-align:center" editable="false" />	
								<ec:column width="8%" property="avgcore" title="平均分" style="text-align:center" editable="false" />					
							</ec:row>
							<c:if test="${msg != null}">
								<ec:extendrow>
