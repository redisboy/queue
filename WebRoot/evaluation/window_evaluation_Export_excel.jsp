...
<%  
	List<WindowEvaluation> list = (List<WindowEvaluation>) request.getSession().getAttribute("list");
    response.reset();  
    response.setContentType("application/vnd.ms-excel;charset=UTF-8");  
    response.setHeader("Content-Disposition", "attachment;filename=" + new String("窗口评价统计.xls".getBytes("gb2312"), "iso8859-1"));  
  
    OutputStream os = response.getOutputStream();  
  
    WritableWorkbook wwb = null;  
    wwb = Workbook.createWorkbook(os);//将 WritableWorkbook 写入到输出流  
    WritableSheet ws = wwb.createSheet("窗口评价统计", 0);//创建第一个sheet  
    ...
    if(role.equals("0")){
    	...
    	ws.addCell(new Label(5, 0, "实际工作量",headerFormat));    	
    	ws.addCell(new Label(6, 0, "非常满意",headerFormat));  
    	ws.addCell(new Label(7, 0, "满意",headerFormat));
    	ws.addCell(new Label(8, 0, "一般",headerFormat));
    	ws.addCell(new Label(9, 0, "不满意",headerFormat));
    	ws.addCell(new Label(10, 0, "次数合计",headerFormat));
    	ws.addCell(new Label(11, 0, "总分",headerFormat));
    	ws.addCell(new Label(12, 0, "平均分",headerFormat));
	    for(int i=0;i<list.size();i++) {   
		    ...
		    ws.addCell(new Label(2, i+1, list.get(i).getAddress(),headerFormat));
    	    ws.addCell(new Label(3, i+1, list.get(i).getXm(),headerFormat));
    	    ws.addCell(new Label(4, i+1, list.get(i).getJhl(),headerFormat));
    	    ws.addCell(new Label(5, i+1, list.get(i).getSjgzl(),headerFormat));
    	    ws.addCell(new Label(6, i+1, list.get(i).getA1(),headerFormat));
    	    ws.addCell(new Label(7, i+1, list.get(i).getA2(),headerFormat));
    	    ws.addCell(new Label(8, i+1, list.get(i).getA3(),headerFormat));
    	    ws.addCell(new Label(9, i+1, list.get(i).getA4(),headerFormat));
    	    ws.addCell(new Label(10, i+1, list.get(i).getCountall(),headerFormat));
    	    ws.addCell(new Label(11, i+1, list.get(i).getSumcore(),headerFormat));
    	    ws.addCell(new Label(12, i+1, list.get(i).getAvgcore(),headerFormat));
		}
    	for(int i=0;i<2;i++){
    		int count=1;
    	...
    	ws.addCell(new Label(1, 0, "窗口名称",headerFormat));  
    	ws.addCell(new Label(2, 0, "经办人",headerFormat));  
    	ws.addCell(new Label(3, 0, "叫号量",headerFormat));  
    	ws.addCell(new Label(4, 0, "实际工作量",headerFormat));    	
    	...
    	ws.addCell(new Label(9, 0, "次数合计",headerFormat));
		...
		for(int i=0;i<list.size();i++) {
		    ...
		    ws.addCell(new Label(1, i+1, list.get(i).getAddress(),headerFormat));
    	    ws.addCell(new Label(2, i+1, list.get(i).getXm(),headerFormat));
    	    ws.addCell(new Label(3, i+1, list.get(i).getJhl(),headerFormat));
    	    ws.addCell(new Label(4, i+1, list.get(i).getSjgzl(),headerFormat));
    	...
    	ws.addCell(new Label(0, 0, "窗口名称",headerFormat));  
    	ws.addCell(new Label(1, 0, "经办人",headerFormat));  
    	ws.addCell(new Label(2, 0, "叫号量",headerFormat));  
    	ws.addCell(new Label(3, 0, "实际工作量",headerFormat));    	
    	...
    	ws.addCell(new Label(8, 0, "次数合计",headerFormat));
    	ws.addCell(new Label(9, 0, "总分",headerFormat));
    	ws.addCell(new Label(10, 0, "平均分",headerFormat));
        for(int i=0;i<list.size();i++) {   
    	    ws.addCell(new Label(0, i+1, list.get(i).getAddress(),headerFormat));
    	    ws.addCell(new Label(1, i+1, list.get(i).getXm(),headerFormat));
    	    ws.addCell(new Label(2, i+1, list.get(i).getJhl(),headerFormat));
    	    ws.addCell(new Label(3, i+1, list.get(i).getSjgzl(),headerFormat));
