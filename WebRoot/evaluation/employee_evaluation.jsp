...
<%
	List<EmployeeEvaluation> list = (List<EmployeeEvaluation>) request.getAttribute("list");
	...
	%>
		window.onload=function(){
			...
			for (EmployeeEvaluation count : list) {
			...
			<%}%>
			var strXML = "<chart xAxisName='' yAxisName='' caption='员工评价统计' showToolTip='0' shownames='1' showvalues='1' showSum='1' useRoundEdges='1'>";
...
function query() { 
	...
	document.form1.action = "ygpjtj.action";
	document.form1.submit();
}
function hpExport(obj){
	window.location.href="/queue/evaluation/employee_evaluation_Export_excel.jsp";
    return true;
}
...
function moveInTdLight(object){
	...
	//判断childlength=12为管理部门+大厅, 11为大厅 
	if(childlength==12){
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td height="51" valign="middle"  background="/queue/images/t-2.jpg">
    	<span style="font-family:'黑体', '宋体';font-size:18px; color:#fff;padding-left:15px;letter-spacing: 10px;letter-spacing: 10px;">员工评价统计</span>
    </td>
    		...
    		<table id="ec_table" class="tableRegion" width="98%" align="center" border="0" cellpadding="0" cellspacing="0">
	    		<thead id="ec_table_head">
	    			<tr>
	    				...
	    				<td valign="middle" style="text-align:center"  width="10%" class="tableHeader" onmouseover="ECSideUtil.lightHeader(this,'ec');" onmouseout="ECSideUtil.unlightHeader(this,'ec');"><div class="headerTitle" >编号</div></td>
				...
				<td> 
					<ec:table items="list" var="list" 
							...
							<ec:row style="text-align:center">
								...
								<ec:column width="8%" property="barid" title="窗口编号" style="text-align:center" editable="false" />
								...
								<ec:column width="9%" property="a5" title="不满意" style="text-align:center" editable="false" />
