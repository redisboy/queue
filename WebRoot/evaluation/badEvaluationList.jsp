...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td height="51" valign="middle"  background="/queue/images/t-2.jpg">
    	<span style="font-family:'黑体', '宋体';font-size:18px; color:#fff;padding-left:15px;letter-spacing: 10px;letter-spacing: 10px;">差评列表</span>
    </td>
	...
	<td> 
		<ec:table items="list" var="list" 
				...
				<ec:row style="text-align:center">
				    ...
				    <ec:column width="20%" property="dmsm1" title="证件类型" style="text-align:center" editable="false" />
				    <ec:column width="20%" property="idnumber" title="证件号码" style="text-align:center" editable="false"/>
				    <ec:column width="15%" property="name" title="业务类型" style="text-align:center" editable="false" />
				    <ec:column property="valuetime" title="评价时间" style="text-align:center" editable="false" />
...
<script type="text/javascript">
	function detailBad(id){
		document.form1.action = "detailBad.action?id="+id;
