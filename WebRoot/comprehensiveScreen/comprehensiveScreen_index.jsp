...
<body>
  ...
  <tr>
    ...
    <td height="51" valign="middle"  background="/queue/images/t-2.jpg">
    	<span style="font-family:'黑体', '宋体';font-size:18px; color:#fff;padding-left:15px;letter-spacing: 10px;letter-spacing: 10px;">综合屏设置</span>
    </td>
  ...
  <tr>
   ...
   <form action="" method="post" name="form1">
    ...
    <input name="button" type="button" class="button" value="添加" onClick="addAdvertise()"/>
	<table width="90%" align="center" border="0" cellpadding="0" cellspacing="0" >
	<tr>
	<td> 
		<ec:table items="list" var="list" 
					action="getComprehensiveScreen.action"
					editable="false" 
					width="100%" 
					listWidth="100%"
					classic="true"
				...
				<ec:row style="text-align:center">
				    <ec:column width="20%" property="message" title="屏幕内容" style="text-align:center" editable="false" />
					<ec:column width="10%" property="record_date" title="录入(修改)时间" style="text-align:center" editable="false" />
                   <ec:column width="10%" property="msg_state" title="状态" style="text-align:center" editable="false" />
...
<script type="text/javascript">
	function addAdvertise(){
		document.form1.action = "to_addComprehensiveScreen.action"; 
		document.form1.submit();
	}
	function updateAdvertise(id){ 
		document.form1.action = "to_updateComprehensiveScreenById.action?id="+id; 
		document.form1.submit();
	}
	function delAdvertise(id){
		if(confirm("确定删除吗?")){ 
		document.form1.action = "delComprehensiveScreen.action?id="+id;
		document.form1.submit();
		}
	}
</script>
