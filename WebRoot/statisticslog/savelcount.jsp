...
function query() { 
	...
	document.form1.action = "savelcountlog.action";
...
function hpExport(obj){
	window.location.href="savelcount_Count_Export_excel.jsp";
    return true;
}
</script>
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td height="51" valign="middle"  background="/queue/images/t-2.jpg">
    	<span style="font-family:'黑体', '宋体';font-size:18px; color:#fff;padding-left:15px;letter-spacing: 10px;letter-spacing: 10px;">安全日志统计</span>
    </td>
     ...
     <input name="flag" id="flag" type="hidden" value="1"/>
          <table width="80%" border="0" cellpadding="1" cellspacing="1" class="table_back">
           ...
           <select name="tjms" id="tjms" >
            ...
            <td class=tableheader1 width=10% height=30>安全审计内容:</td>
          	<td width=150 bgColor=#f1f9fd height=30>&nbsp;
	          	<input name="securityContext" id="securityContext" type="text" class="inputface"  value=""/>
           </td>
            </tr>
            <tr>
            </tr>
	...
	<td> 
		<ec:table items="list" var="list" 
				...
				<ec:row style="text-align:center">
					<ec:column width="40%" property="userName" title="用户名" style="text-align:center" editable="false" />
					<ec:column width="40%" property="saveCel" title="安全审计" style="text-align:center" editable="false" />
					<ec:column width="20%" property="saveCount" title="数量" style="text-align:center" editable="false" />
				</ec:row>
				<c:if test="${msg != null}">
				<ec:extendrow>
