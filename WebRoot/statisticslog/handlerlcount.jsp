...
function query() { 
	...
	document.form1.action = "handlerlcountlog.action";
...
function hpExport(obj){
	window.location.href="handlerlcount_Count_Export_excel.jsp";
    return true;
}
</script>
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td height="51" valign="middle"  background="/queue/images/t-2.jpg">
    	<span style="font-family:'黑体', '宋体';font-size:18px; color:#fff;padding-left:15px;letter-spacing: 10px;letter-spacing: 10px;">操作日志统计</span>
    </td>
  ...
  <tr>
	...
	<td> 
		<ec:table items="list" var="list" 
					action="handlerlcountlog.action"
					editable="false" 
					width="100%" 
					listWidth="100%"
					classic="true"
				...
				<ec:row style="text-align:center">
					<ec:column width="18%" property="userName" title="用户名" style="text-align:center" editable="false" />
					<ec:column width="16%" property="module" title="模块" style="text-align:center" editable="false" />
					<ec:column width="16%" property="moduleType" title="模块细类" style="text-align:center" editable="false" />
					<ec:column width="10%" property="zen" title="增" style="text-align:center" editable="false" />
					<ec:column width="10%" property="sha" title="删" style="text-align:center" editable="false" />
					<ec:column width="10%" property="gai" title="改" style="text-align:center" editable="false" />
					<ec:column width="10%" property="cha" title="查" style="text-align:center" editable="false" />
					<ec:column width="10%" property="zon" title="总计" style="text-align:center" editable="false" />
				</ec:row>
				<c:if test="${msg != null}">
				<ec:extendrow>
