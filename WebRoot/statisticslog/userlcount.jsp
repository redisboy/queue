...
function query() { 
	...
	document.form1.action = "userlcountlog.action";
...
function hpExport(obj){
	window.location.href="userlcount_Count_Export_excel.jsp";
    return true;
}
</script>
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td height="51" valign="middle"  background="/queue/images/t-2.jpg">
    	<span style="font-family:'黑体', '宋体';font-size:18px; color:#fff;padding-left:15px;letter-spacing: 10px;letter-spacing: 10px;">用户登录统计</span>
    </td>
     ...
     <input name="flag" id="flag" type="hidden" value="1"/>
          <table width="80%" border="0" cellpadding="1" cellspacing="1" class="table_back">
           ...
           <select name="tjms" id="tjms" >
            ...
            <td width="10%" height="25" bgcolor="#FFFFFF" class="tableheader1">ip地址:</td>
              <td width=150 bgColor=#f1f9fd height=30>&nbsp;
	          	<input name="loginIP" id="loginIP" type="text" class="inputface" value=""/>
             </td>
           </td>
            </tr>
            <tr>
	...
	<td> 
		<ec:table items="list" var="list" 
				...
				<ec:row style="text-align:center">
					...
					<ec:column width="8%" property="loginIP" title="登录IP" style="text-align:center" editable="false" />
					<ec:column width="20%" property="loginCount" title="登录次数" style="text-align:center" editable="false" />
					<ec:column width="20%" property="counts" title="统计" style="text-align:center" editable="false" />
				</ec:row>
				<c:if test="${msg != null}">
				<ec:extendrow>
