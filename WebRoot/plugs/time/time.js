...
strFrame+='        <td colspan=3 align=right Author=meizz><span onclick=parent.clearLayer() style="font-size:12px;cursor: hand"';
...
strFrame+='             Author=meizz align=center><input Author=meizz style="cursor:hand"  type=button class=button value="今  天" onclick="parent.meizzToday()" ';
...
function meizzToday()  //Today Button
{
	...
	if(meizzTheMonth.length=1){
		if(meizzTheMonth<10){
			meizzTheMonth='0'+meizzTheMonth;
		}
		meizzTheMonth=meizzTheMonth;
	}
	//alert(meizzTheMonth);
