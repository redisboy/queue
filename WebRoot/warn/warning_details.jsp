...
<%
	List<LogVo> list = (List<LogVo>) request.getAttribute("loglist");
...
function hpExport(obj){
	window.location.href="/queue/warn/warning_details_Export.jsp";
    return true;
}
</script>
<body>
  ...
  <tr>
    ...
    <td height="51" valign="middle"  background="/queue/images/t-2.jpg">
    	<span style="font-family:'黑体', '宋体';font-size:18px; color:#fff;padding-left:15px;letter-spacing: 10px;letter-spacing: 10px;">警告人员列表详细</span>
    </td>
  ...
  <tr>
   ...
   <form action="" method="post" name="form1">
	...
	<tr>
	<td> 
		<ec:table items="loglist" var="list" 
				...
				<ec:row style="text-align:center">
				    ...
				    <ec:column width="20%" property="barId" title="窗口号" style="text-align:center" editable="false" />
					<ec:column width="10%" property="createTime" title="警告时间" style="text-align:center" editable="false" />
				</ec:row>
				<c:if test="${msg != null}">
				<ec:extendrow>
