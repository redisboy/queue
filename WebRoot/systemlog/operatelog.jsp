...
<%
	List<Operate> list = (List<Operate>) request.getAttribute("list");
...
function qureyDetailed(id){
	jQuery.ajax({type: "POST", cache: false,dataType: "json",async: false,
		url: "operatelogmx.action?id="+id+"&"+parseInt(Math.random()*100000),
		...
		var core = document.getElementById('coreb');
		core.innerText = lcore;
...
function query() { 
	...
	document.form1.action = "operatelog.action";
...
function checkEmpty(){
	...
	var originIp=document.getElementById("originIp");
	var eventType=document.getElementById("core");
	if(!(text=='手动汇总')){
		query();
	}else{
		if(!(ksrq==''||jsrq=='')){
...
function hpExport(obj){
	window.location.href="operatelog_Count_Export_excel.jsp";
    return true;
}
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td height="51" valign="middle"  background="/queue/images/t-2.jpg">
    	<span style="font-family:'黑体', '宋体';font-size:18px; color:#fff;padding-left:15px;letter-spacing: 10px;letter-spacing: 10px;">操作日志查询</span>
    </td>
    ...
    <form action="" method="post" name="form1">
     <input name="flag" id="flag" type="hidden" value="1"/>
          <table width="80%" border="0" cellpadding="1" cellspacing="1" class="table_back">
           ...
           <td class=tableheader1 width=10% height=30>核心业务:</td>
            <td width=150 bgColor=#f1f9fd height=30>&nbsp;
	...
	<td> 
		<ec:table items="list" var="list" 
				...
				<ec:row style="text-align:center">
					...
					<ec:column width="8%" property="opName" title="被操作用户" style="text-align:center" editable="false" />
					<ec:column width="15%" property="originIp" title="来源" style="text-align:center" editable="false" />
					<ec:column width="8%" property="module" title="模块" style="text-align:center" editable="false" />
					<ec:column width="8%" property="moduleType" title="模块细类" style="text-align:center" editable="false" />
					<ec:column width="6%" property="eventType" title="类型" style="text-align:center" editable="false" />
					<ec:column width="6%" property="coreBusiness" title="核心业务" style="text-align:center" editable="false" />
					<ec:column width="18%" property="event" title="事件" style="text-align:center" editable="false" />
					<ec:column width="18%" property="oTime" title="操作时间" style="text-align:center" editable="false" />
					<ec:column width="23%" property="resultDepict" title="结果描述" style="text-align:center" editable="false" />
				</ec:row>
				<c:if test="${msg != null}">
				<ec:extendrow>
...
<!-- 查看明細 -->
	<div id="_mx" class="message" style="display:none;">
		<table class="messagetable">
			...
			<tr>
				<td  style="background-color: powderblue;">操作行为</td>
				<td  id="event"></td>
				<td  style="background-color: powderblue;">核心业务</td>
				<td  id="coreb"></td>
			</tr>
			<tr>
