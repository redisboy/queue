...
<%
	...
	%>
		window.onload=function(){
			...
			<%}}%>
			var strXML = "<graph rotateYAxisName='0' caption='部门等候时间预警'  showToolTip='0' showSum='1' shownames='1' showvalues='1' showSum='1' decimalPrecision='1' formatNumberScale='1' useRoundEdges='1'>"
...
function query() { 
	...
	document.form1.action = "getDepartWaitTimeWarning.action?flag=1";
	document.form1.submit();
}
function hpExport(obj){
	window.location.href="/queue/ywshtj/departWaitTimeWarning_Export_excel.jsp";
    return true;
}
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td height="51" valign="middle"  background="/queue/images/t-2.jpg">
    	<span style="font-family:'黑体', '宋体';font-size:18px; color:#fff;padding-left:15px;letter-spacing: 10px;letter-spacing: 10px;">部门等候时间预警</span>
    </td>
  ...
  <tr>
	...
	<td> 
		<ec:table items="list" var="list" 
					action="getDepartWaitTimeWarning.action?flag=1"
					editable="false" 
					width="100%" 
					listWidth="100%"
					classic="true"
