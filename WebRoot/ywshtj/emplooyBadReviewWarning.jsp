...
<%
	...
	%>
		window.onload=function(){
			var str1 = "", str2="", str3="", str4="", str5="",sumAvg="";
			<% 
			...
			<%}}%>
			var strXML = "<graph rotateYAxisName='0' caption='差评率预警'  showToolTip='0' showSum='1' shownames='1' showvalues='1' showSum='1' decimalPrecision='1' formatNumberScale='1' useRoundEdges='1'>"
			strXML += "<categories>"+str1+"</categories>";
			strXML += "<dataset seriesName='不满意' color='' showValues='' showSum='1'>"+str5+"</dataset>";
...
function query() { 
	...
	<%if(flag.equals("0")){ %>
	document.form1.action = "getEmplooyBadReviewWarning.action?flag=0";
	<%}else{%>
	document.form1.action = "getEmplooyBadReviewWarning.action?flag=1";
	<%}%>
	document.form1.submit();
}
function hpExport(obj){
	window.location.href="/queue/ywshtj/emplooyBadReviewWarning_Export_excel.jsp";
    return true;
}
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td height="51" valign="middle"  background="/queue/images/t-2.jpg">
    	<span style="font-family:'黑体', '宋体';font-size:18px; color:#fff;padding-left:15px;letter-spacing: 10px;letter-spacing: 10px;">差评率预警</span>
    </td>
  ...
  <tr>
	...
	<% if(flag.equals("0")){ %> 
		<ec:table items="list" var="list" 
					action="getEmplooyBadReviewWarning.action?flag=0"
					editable="false" 
					width="100%" 
					listWidth="100%"
					classic="true"
	...
	<%}}else{ %>
	<ec:table items="list" var="list" 
					action="getEmplooyBadReviewWarning.action?flag=1"
					editable="false" 
					width="100%" 
					listWidth="100%"
					classic="true"
