...
<%
	...
	%>
		window.onload=function(){
			...
			<%}%>
			var strXML = "<chart xAxisName='' yAxisName='' caption='暂停考核' showToolTip='0' shownames='1' showvalues='1' showSum='1' useRoundEdges='1'>";
			strXML += "<categories>"+str1+"</categories>";
			strXML += "<dataset seriesName='暂停时间' color='' showValues=''>"+str2+"</dataset></chart>";
...
function query() { 
	...
	<%if(flag.equals("0")){ %>
	document.form1.action = "getEmplooyPauseTimeOrder.action?flag=0";
	<%}else{%>
	document.form1.action = "getEmplooyPauseTimeOrder.action?flag=1";
	<%}%>
	document.form1.submit();
}
function hpExport(obj){
	window.location.href="/queue/ywshtj/emplooyPauseTimeOrder_Export_excel.jsp";
    return true;
}
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td height="51" valign="middle"  background="/queue/images/t-2.jpg">
    	<span style="font-family:'黑体', '宋体';font-size:18px; color:#fff;padding-left:15px;letter-spacing: 10px;letter-spacing: 10px;">暂停考核</span>
    </td>
  ...
  <tr>
	...
	<% if(flag.equals("0")){ %> 
		<ec:table items="list" var="list" 
					action="getEmplooyPauseTimeOrder.action?flag=0"
					editable="false" 
					width="100%" 
					listWidth="100%"
					classic="true"
	...
	<%}}else{ %>
		<ec:table items="list" var="list" 
					action="getEmplooyPauseTimeOrder.action?flag=1"
					editable="false" 
					width="100%" 
					listWidth="100%"
					classic="true"
				...
				<ec:row style="text-align:center">
					<ec:column width="8%" property="deptcode" title="所属部门编号" style="text-align:center" editable="false" />
					<ec:column width="10%" property="pausetime" title="平均暂停时间" style="text-align:center" editable="false" />
				</ec:row>
				<c:if test="${msg != null}">
				<ec:extendrow>
			<tr style="background-color:#ffeedd" title="">
