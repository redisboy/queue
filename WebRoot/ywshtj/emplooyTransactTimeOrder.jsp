...
<%
	...
	%>
		window.onload=function(){
			...
			<%}%>
			var strXML = "<chart xAxisName='' yAxisName='' caption='员工办理业务时间考核' showToolTip='0' shownames='1' showvalues='1' showSum='1' useRoundEdges='1'>";
...
function query() { 
	...
	<%if(flag.equals("0")){ %>
	document.form1.action = "getEmplooyTransactTimeOrder.action?flag=0";
	<%}else{%>
	document.form1.action = "getEmplooyTransactTimeOrder.action?flag=1";
	<%}%>
	document.form1.submit();
}
function hpExport(obj){
	window.location.href="/queue/ywshtj/emplooyTransactTimeOrder_Export_excel.jsp";
    return true;
}
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td height="51" valign="middle"  background="/queue/images/t-2.jpg">
    	<span style="font-family:'黑体', '宋体';font-size:18px; color:#fff;padding-left:15px;letter-spacing: 10px;letter-spacing: 10px;">员工办理业务时间考核</span>
    </td>
  ...
  <tr>
	...
	<% if(flag.equals("0")){ %> 
		<ec:table items="list" var="list" 
					action="getEmplooyTransactTimeOrder.action?flag=0"
					editable="false" 
					width="100%" 
					listWidth="100%"
					classic="true"
	...
	<%}}else{ %>
		<ec:table items="list" var="list" 
					action="getEmplooyTransactTimeOrder.action?flag=1"
					editable="false" 
					width="100%" 
					listWidth="100%"
					classic="true"
