...
<%  
    ...
    response.setHeader("Content-Disposition", "attachment;filename=" + new String("管理部门等候时间考核.xls".getBytes("gb2312"), "iso8859-1"));  
  
    OutputStream os = response.getOutputStream();  
  
    WritableWorkbook wwb = null;  
    wwb = Workbook.createWorkbook(os);//将 WritableWorkbook 写入到输出流  
    WritableSheet ws = wwb.createSheet("管理部门等候时间考核", 0);//创建第一个sheet  
