...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td height="51" valign="middle"  background="/queue/images/t-2.jpg">
    	<span style="font-family:'黑体', '宋体';font-size:18px; color:#fff;padding-left:15px;letter-spacing: 10px;letter-spacing: 10px;">修改指纹信息</span>
    </td>
  ...
  <tr>
    ...
    <table width="40%" border="0" cellpadding="1" cellspacing="1" class="table_back">
      <tr>
        ...
        <td width="30%" height="35" bgcolor="#F1F9FD">&nbsp;${idNumber }
        </td>
      </tr>
      <tr>
...
function addZhiWen(){
    ...
    document.form1.action = "number/saveZhiWen.action?idNumber="+idNumber+"&zwbase64="+zhiwenBase+"&flag=1";
