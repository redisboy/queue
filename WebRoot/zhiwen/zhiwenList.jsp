...
function query() { 
	...
	document.form1.action = "getAllZhiWen.action?idNumber="+idnumber;
	document.form1.submit();
}
function updateZhiWen(idnumber){
	document.form1.action = "to_updateZhiWen.action?idNumber="+idnumber+"&flag=1";
	document.form1.submit();
}
function delZhiWen(idnumber){
if(confirm("确定要删除记录吗？")){
	document.form1.action = "saveZhiWen.action?idNumber="+idnumber+"&flag=2";
	document.form1.submit();
	}else{
		return;
	}
...
function to_add(){
	document.form1.action = "to_addZhiWen.action";
	document.form1.submit();
}
</script>
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td height="51" valign="middle"  background="/queue/images/t-2.jpg">
    	<span style="font-family:'黑体', '宋体';font-size:18px; color:#fff;padding-left:15px;letter-spacing: 10px;letter-spacing: 10px;">指纹补录</span>
    </td>
	...
	<td> 
		<ec:table items="list" var="list" 
				...
				<ec:row style="text-align:center">
					<ec:column width="7%" property="IDNumber" title="身份证号码" style="text-align:center" editable="false" />
