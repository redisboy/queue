...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
   		<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
			...
			<tr>
				...
				<td height="51" valign="middle" background="images/t-2.jpg">
					<span style="font-family: '黑体', '宋体'; font-size: 18px; color: #fff; padding-left: 15px; letter-spacing: 10px; letter-spacing: 10px;">修改退办信息</span>
				</td>
						...
						<table id="myTable" width="60%" border="0" cellpadding="1" cellspacing="1" class="table_back">
							<tr>
				    			...
				    			<td width="80%" height="35" bgcolor="#F1F9FD">&nbsp;
				    				<input name="idnumber" id="idnumber" style="width: 300px;" value="${tuiban.idnumber}" readonly="readonly"/>
				    			</td>
				    		</tr>
				    		<tr>
				    		<td width="20%" height="35" bgcolor="#FFFFFF" class="tableheader1">原因：</td>
				    			<td width="80%" height="35" bgcolor="#F1F9FD">&nbsp;
				    				<textarea name="reason" id="reason" rows="10" cols="50">${tuiban.yuanyin}</textarea>
				    			</td>
				    		</tr>
						</table>
					</form>
					<input name="bt1" class="button" type="button" value=" 添加 " onClick="addTuiban()" />
	...
	<script type="text/javascript">
		function addTuiban(){
			document.form1.action = "insertTuiban.action?clientIp="+"<%=clientIp%>"; 
