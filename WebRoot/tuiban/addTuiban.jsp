   		...
   		<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
			...
			<tr>
				...
				<td height="51" valign="middle" background="images/t-2.jpg">
					<span style="font-family: '黑体', '宋体'; font-size: 18px; color: #fff; padding-left: 15px; letter-spacing: 10px; letter-spacing: 10px;">添加退办信息</span>
				</td>
						...
						<table id="myTable" width="60%" border="0" cellpadding="1" cellspacing="1" class="table_back">
							<tr>
				    			...
				    			<td width="80%" height="35" bgcolor="#F1F9FD">&nbsp;
				    				<input name="idnumber" id="idnumber" style="width: 300px" value=""/>
				    			</td>
				    		</tr>
				    		<tr>
