...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td height="51" valign="middle"  background="/queue/images/t-2.jpg">
    	<span style="font-family:'黑体', '宋体';font-size:18px; color:#fff;padding-left:15px;letter-spacing: 10px;letter-spacing: 10px;">添加等待区域</span>
    </td>
  ...
  <tr>
      ...
      <tr>
        ...
        <td width="30%" height="35" bgcolor="#F1F9FD">&nbsp;
        	<select name="id" id="id">
        		<c:forEach items="${list}" var="wait">
        			<option value="${wait.id}">${wait.name}</option>
        		</c:forEach>
        	</select>
        </td>
      </tr>
       <tr>
        ...
        <td width="30%" height="35" bgcolor="#F1F9FD">&nbsp;
          <input name="waitingarea" id="waitingarea" maxlength="10" style="width:250px"    />
    ...
    <br>
      <br>
	  <input name="bt1" class="button" type="button" value=" 添加 " onClick="addWaitingarea()"/>
