...
<body>
  ...
  <tr>
    ...
    <td height="51" valign="middle"  background="/queue/images/t-2.jpg">
    	<span style="font-family:'黑体', '宋体';font-size:18px; color:#fff;padding-left:15px;letter-spacing: 10px;letter-spacing: 10px;">等待区域设置</span>
    </td>
  ...
  <tr>
   ...
   <form action="" method="post" name="form1">
    ...
    <input name="button" type="button" class="button" value="添加" onClick="addWaitingarea()"/>
	...
	<td> 
		<ec:table items="list" var="list" 
				...
				<ec:row style="text-align:center">
					...
					<ec:column width="10%" property="waitingarea" title="等待区域" style="text-align:center" editable="false" />
...
<script type="text/javascript">
	function addWaitingarea(){
		document.form1.action = "into_insertWaitingarea.action"; 
		document.form1.submit();
	}
	function updateWaitingarea(id){ 
		document.form1.action = "into_updateWaitingarea.action?id="+id; 
		document.form1.submit();
	}
	function delWaitingarea(id){
		if(confirm("确定删除吗?")){ 
		document.form1.action = "delWaitingarea.action?id="+id;
		document.form1.submit();
		}
	}
</script>
