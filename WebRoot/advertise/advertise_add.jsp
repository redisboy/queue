...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <table width="50%" border="0" cellpadding="1" cellspacing="1" class="table_back">
      <tr>
        ...
        <td width="80%" height="35" bgcolor="#F1F9FD">&nbsp;
         <textarea rows="5" style="width: 300px;" name="message"></textarea>
    ...
    <br>
      <br>
	  <input name="bt1" class="button" type="button" value=" 添加 " onClick="addAdvertise()"/>
...
function addAdvertise(){
    ...
    document.form1.action = "addAdvertise.action";
