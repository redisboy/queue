...
<body>
  ...
  <tr>
    ...
    <td height="51" valign="middle"  background="/queue/images/t-2.jpg">
    	<span style="font-family:'黑体', '宋体';font-size:18px; color:#fff;padding-left:15px;letter-spacing: 10px;letter-spacing: 10px;">广告设置</span>
    </td>
	...
	<td> 
		<ec:table items="list1" var="list1" 
				...
				<ec:row style="text-align:center">
				    <ec:column width="20%" property="message" title="广告内容" style="text-align:center" editable="false" />
...
<script type="text/javascript">
	function addAdvertise(){
		document.form1.action = "into_addAdvertise.action"; 
		document.form1.submit();
	}
	function updateAdvertise(id){ 
		document.form1.action = "updateAdvertise.action?id="+id; 
		document.form1.submit();
	}
	function delAdvertise(id){
		if(confirm("确定删除吗?")){ 
		document.form1.action = "delAdvertise.action?id="+id;
		document.form1.submit();
		}
	}
</script>
