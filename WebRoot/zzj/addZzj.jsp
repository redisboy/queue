...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
   		<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
			...
			<tr>
				...
				<td height="51" valign="middle" background="images/t-2.jpg">
					<span style="font-family: '黑体', '宋体'; font-size: 18px; color: #fff; padding-left: 15px; letter-spacing: 10px; letter-spacing: 10px;">添加自助机缺纸信息</span>
				</td>
						...
						<table id="myTable" width="60%" border="0" cellpadding="1" cellspacing="1" class="table_back">
							<tr>
				    			...
				    			<td width="80%" height="35" bgcolor="#F1F9FD">&nbsp;
				    				<input name="qhjip" id="qhjip" style="width: 150px"/>
				    			</td>
				    		</tr>
				   			<tr>
				    			<td width="20%" height="35" bgcolor="#FFFFFF" class="tableheader1">总打印张数：</td>
				    			<td width="80%" height="35" bgcolor="#F1F9FD">&nbsp;
				    				<input name="zdyzs" id="zdyzs" style="width: 100px" maxlength="18"/>
				    			</td>
				    		</tr>
				    		<tr>
				    		<td width="20%" height="35" bgcolor="#FFFFFF" class="tableheader1">报警张数：</td>
				    			<td width="80%" height="35" bgcolor="#F1F9FD">&nbsp;
				    				<input name="bjzs" id="bjzs" style="width: 100px"/>
				    			</td>
				    		</tr>
						</table>
					</form>
					<input name="bt1" class="button" type="button" value=" 添加 " onClick="addZzj()" />
	...
	<script type="text/javascript">
		function addZzj(){
			form1.action = "zzj/AddZzj.action";
			form1.submit();
		}
	</script>
</html>
