...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <input name="button" type="button" class="button" value="查询" onClick="checkEmpty()"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<script type="text/javascript">
	...
	function voicelzxx(id){
		if(confirm("确定发声吗?")){ 
			document.form1.action = "voicelzxx.action?lsh="+id+"&clientIp="+"<%=clientIp%>";
			document.form1.submit();
		}
	}
	function shangping(){
	...
	function checksxh(){
		document.form1.action = "queryAllLzxxBysxh.action?clientIp="+"<%=clientIp%>"; 
		document.form1.submit();
	}
</script>
</html>