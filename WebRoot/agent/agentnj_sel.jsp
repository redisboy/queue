...
function query() { 
	...
	if(reg.test(id)||id==""){
		document.form1.action = "dlrnjsel.action";
		...
		<ec:table items="list" var="list" 
				...
				<ec:row style="text-align:center">
                    ...
                    <ec:column width="10%" property="status" title="状态" style="text-align:center" editable="false" />
                     <ec:column width="10%" property="updnj" title="年检" style="text-align:center" editable="false" />                                                                         
				</ec:row>
	</ec:table><br>
</td>
	</tr>
