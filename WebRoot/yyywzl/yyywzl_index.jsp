...
<script type="text/javascript">
	...
	function addYyywzl() {
		document.form1.action = "fromAddYyywzl.action"; 
		document.form1.submit();
	}
	
	function updateYyywzl(id){ 
		document.form1.action = "fromUpdateYyywzl.action?id="+id; 
		document.form1.submit();
	}
	function delYyywzl(id){
		if(confirm("确定删除吗?")){ 
		document.form1.action = "delYyywzl.action?id="+id;
		document.form1.submit();
		}
	}
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td height="51" valign="middle"  background="/queue/images/t-2.jpg">
    	<span style="font-family:'黑体', '宋体';font-size:18px; color:#fff;padding-left:15px;letter-spacing: 10px;letter-spacing: 10px;">预约业务所需资料</span>
    </td>
  ...
  <tr>
   ...
   <form action="" method="post" name="form1">
    ...
    <input name="button" type="button" class="button" value="添加" onClick="addYyywzl()"/>
	<table width="90%" align="center" border="0" cellpadding="0" cellspacing="0" >
	<tr>
	<td> 
		<ec:table items="list" var="list" 
					action="yyywzl.action"
					editable="false" 
					width="100%" 
					listWidth="100%"
					classic="true"
				...
				<ec:row style="text-align:center">
				    <ec:column width="10%" property="zlmc" title="资料名称" style="text-align:center" editable="false" />
