CC.Tpl.def('CC.ui.Button', '<table cellspacing="0" cellpadding="0" border="0"><tbody><tr><td class="g-btn-l"><i>&nbsp;</i></td><td class="g-btn-c"><em unselectable="on"><button type="button" class="g-btn-text" id="_tle" hideFocus="true" ></button></em></td><td class="g-btn-r" hideFocus="true" ><i>&nbsp;</i></td></tr></tbody></table>');
/**
 * @class CC.ui.Button
 * @extends CC.Base
 */
