...
return {
  ...
  alert: function(msg, title, callback, buttons, modalParent, defButton) {
    ...
    s.setTitle(title)
     .setSize(450, 153)
     .wrapper.html('<div class="msgbox-dlg"><iframe hideFocus="true"  frameborder="0" src="" style="position:absolute;z-index:-1;width:100%;height:100%;top:0px;left:0px;filter:progid:DXImageTransform.Microsoft.Alpha(opacity=0)"></iframe>' + (msg||'') + '</div>');
