CC.Tpl.def('CC.ui.Dialog.Bottom', '<div class="g-win-bottom"><iframe hideFocus="true"  frameborder="0" src="" style="position:absolute;z-index:-1;width:100%;height:100%;top:0px;left:0px;filter:progid:DXImageTransform.Microsoft.Alpha(opacity=0)"></iframe><div class="bottom-wrap"></div></div>');
/**
 * @class CC.ui.Dialog
