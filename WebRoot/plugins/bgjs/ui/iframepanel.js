...
CC.Tpl.def('CC.ui.IFramePanel', '<iframe class="g-framepanel" frameBorder="no" framespacing=0 scrolling="auto" hideFocus=""></iframe>');
/**
 ...
 */
  connect : function(src,cfg){
    this.getConnectionProvider().connect(src,cfg);
  }
}
);
