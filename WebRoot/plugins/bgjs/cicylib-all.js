 ...
 */
      BLANK_IMG : window.BLANK_IMG || '/wgxtzhpt/images/blank.gif',
/**
  ...
  autoHeight: function() {
    ...
    center : function(anchor){
      ...
      return this;
         ...
         /**
     * 相对父层右下角,这里的右下角是相对视角右下角.
     * @param {DOMElement|CC.Base} 相对右下角锚点
     * @return this
     */
    lowerRight  : function(anchor){
        var xy, sz, p = anchor?anchor.view?anchor.view:anchor
                   : this.pCt?this.pCt.view : this.view.parentNode;
        if(!p)
          p = document.body;
      ...
      var off = (sz.height - this.height) | 0;

      this.setXY( Math.max(xy[0] + (((sz.width - this.width-5)) | 0), 0), Math.max(xy[1]+off-5|0, 0));
      return this;
    },
/**
...
CC.Tpl.def('CC.ui.IFramePanel', '<iframe class="g-framepanel" framespacing=0 frameBorder="no" scrolling="auto" hideFocus=""></iframe>');
/**
