...
<script language="JavaScript">
		function  addYydt(){
			...
			document.form1.action = "addYydt.action?yysds="+check_val; 
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td height="51" valign="middle"  background="/queue/images/t-2.jpg">
    	<span style="font-family:'黑体', '宋体';font-size:18px; color:#fff;padding-left:15px;letter-spacing: 10px;letter-spacing: 10px;">新增预约大厅信息</span>
    </td>
  ...
  <tr>
    ...
    <table width="60%" border="0" cellpadding="1" cellspacing="1" class="table_back">
      <tr>
		...
		<textarea rows="5" style="width: 300px;"  id="blddz" name="blddz"></textarea><br/>
		</td>
		</tr>
        ...
        <td width="30%" height="35" bgcolor="#F1F9FD">&nbsp;
          <input name="yyts" id="yyts" maxlength="20" style="width:200px"    />
          &nbsp;<font  color="#ff0000"></font>
        </td>
      </tr>
      ...
      <tr id="roletr">
		...
		<td width="80%" height="35" bgcolor="#F1F9FD">
			...
			&nbsp;
			<input type="checkbox" name="yysd"  value="09:30-10:30" />09:30-10:30
			&nbsp;
			<input type="checkbox" name="yysd"  value="14:00-15:00" />14:00-15:00
			&nbsp;
			<input type="checkbox" name="yysd"  value="15:00-16:00" />15:00-16:00
			&nbsp;
		</td>
	  </tr>
    ...
    <br>
      <br>
	  <input name="bt1" class="button" type="button" value=" 添加 " onClick="addYydt()"/>
