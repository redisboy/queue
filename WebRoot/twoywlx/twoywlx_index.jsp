...
<script type="text/javascript">
	...
	function addTwoywlx() {
		document.form1.action = "fromAddTwoywlx.action"; 
		document.form1.submit();
	}
	
	function updateTwoywlx(id){ 
		document.form1.action = "fromUpdateTwoywlx.action?id="+id; 
		document.form1.submit();
	}
	function delTwoywlx(id){
		if(confirm("确定删除吗?")){ 
		document.form1.action = "delTwoywlx.action?id="+id;
		document.form1.submit();
		}
	}
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td height="51" valign="middle"  background="/queue/images/t-2.jpg">
    	<span style="font-family:'黑体', '宋体';font-size:18px; color:#fff;padding-left:15px;letter-spacing: 10px;letter-spacing: 10px;">预约二级业务类型</span>
    </td>
  ...
  <tr>
   ...
   <form action="" method="post" name="form1">
    ...
    <input name="button" type="button" class="button" value="添加" onClick="addTwoywlx()"/>
	<table width="90%" align="center" border="0" cellpadding="0" cellspacing="0" >
	<tr>
	<td> 
		<ec:table items="list" var="list" 
					action="twoywlx.action"
					editable="false" 
					width="100%" 
					listWidth="100%"
					classic="true"
				...
				<ec:row style="text-align:center">
					<ec:column width="10%" property="oneywlxName" title="一级业务名称" style="text-align:center" editable="false" />
				    <ec:column width="10%" property="name" title="业务名称" style="text-align:center" editable="false" />
					<ec:column width="10%" property="dtyysl" title="预约数量" style="text-align:center" editable="false" />
