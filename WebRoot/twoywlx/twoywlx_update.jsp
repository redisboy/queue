...
<script type="text/javascript">
	...
	function updateTwoywlx() {
		var yysl=$("#yysl").val();
		var dtId=$("#dtId").val();
		 document.form1.action = "updateTwoywlx.action?yysl="+yysl+"&dtId="+dtId; 
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td height="51" valign="middle"  background="/queue/images/t-2.jpg">
    	<span style="font-family:'黑体', '宋体';font-size:18px; color:#fff;padding-left:15px;letter-spacing: 10px;letter-spacing: 10px;">修改二级业务类型</span>
    </td>
  ...
  <tr>
    ...
    <table width="69%" border="0" cellpadding="1" cellspacing="1" class="table_back">
      ...
      <tr>
        ...
        <td width="30%" height="35" bgcolor="#F1F9FD">&nbsp;
          <input name="name" id="name" maxlength="20" style="width:200px"  value="${twoywlx.name }"   />
          &nbsp;<font  color="#ff0000"></font>
          <input name="id" id="id" type="hidden" value="${twoywlx.id }" />
        </td>
      </tr>
    ...
    <br>
      <br>
	  <input name="bt1" class="button" type="button" value=" 修改" onClick="updateTwoywlx()"/>
