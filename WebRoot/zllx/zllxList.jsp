...
function updateZllx(zllxbh){
	document.form1.action = "code/to_updateZllx.action?zllxbh="+zllxbh+"&flag=1";
	document.form1.submit();
}
function delZllx(zllxbh){
if(confirm("确定要删除记录吗？")){
	document.form1.action = "saveZllx.action?zllxbh="+zllxbh+"&flag=2";
	document.form1.submit();
	}else{
		return;
	}
...
function to_add(){
	document.form1.action = "to_addZllx.action?flag=2";
	document.form1.submit();
}
</script>
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td height="51" valign="middle"  background="/queue/images/t-2.jpg">
    	<span style="font-family:'黑体', '宋体';font-size:18px; color:#fff;padding-left:15px;letter-spacing: 10px;letter-spacing: 10px;">资料类型列表</span>
    </td>
    ...
    <form action="" method="post" name="form1">
     ...
     <input name="flag" id="flag" type="hidden" value="1"/>
          <table width="60%" border="0" cellpadding="1" cellspacing="1" class="table_back">
            <tr>
            <td class=tableheader1 width=30% height=30>身份证号:</td>
          	<td width=150 bgColor=#f1f9fd height=30>&nbsp;
	          <input name="idnumber" id="idnumber" type="text" class="inputface" value=""/>
           	</td>
          	<td width=100 bgColor=#f1f9fd height=30 align="center">&nbsp;<img src='/queue/images/button_ck.jpg' style='cursor:hand' onClick="query()"></td>
            </tr>

          </table>
          <br/>
          -->
          <img src='/queue/images/button_add.jpg' style='cursor:hand' onClick="to_add()">
	</form>
	...
	<td> 
		<ec:table items="list" var="list" 
				...
				<ec:row style="text-align:center">
				    <ec:column width="15%" property="dm" title="类型编号" style="text-align:center" editable="false" />
				    <ec:column width="20%" property="mc" title="类型名称" style="text-align:center" editable="false" />
