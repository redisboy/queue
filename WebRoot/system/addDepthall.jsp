...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
		<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
			...
			<tr>
				...
				<td height="51" valign="middle" background="images/t-2.jpg">
					<span style="font-family: '黑体', '宋体'; font-size: 18px; color: #fff; padding-left: 15px; letter-spacing: 10px; letter-spacing: 10px;">添加大厅</span>
				</td>
						...
						<table id="myTable" width="60%" border="0" cellpadding="1" cellspacing="1" class="table_back">
							<tr id="nwindowDmlbTr">
				    			...
				    			<td width="80%" height="35" bgcolor="#F1F9FD">&nbsp;
				    				<input id="dmz" name="dmz" onchange="dmzChange()"/>
				    			</td>
				    		</tr>
				   			<tr>
				    			<td width="20%" height="35" bgcolor="#FFFFFF" class="tableheader1">大厅名称：</td>
				    			<td width="80%" height="35" bgcolor="#F1F9FD">&nbsp;
				    				<input id="dmsm1" name="dmsm1"/>
				    			</td>
				    		</tr>
						</table>
					</form>
					<input name="bt1" class="button" type="button" value=" 添加 " onClick="addDepthall()" />
	...
	<script type="text/javascript" src="system/js/setDepthall.js"></script>
