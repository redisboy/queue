...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td height="51" valign="middle"  background="/queue/images/t-2.jpg">
    	<span style="font-family:'黑体', '宋体';font-size:18px; color:#fff;padding-left:15px;letter-spacing: 10px;letter-spacing: 10px;">大厅列表</span>
    </td>
  ...
  <tr>
	...
	<input name="button" type="button" class="button" value="添加" onClick="addDepthall()"/><br/><br/>
	...
	<td> 
		<ec:table items="list" var="list" 
				...
				<ec:row style="text-align:center">
				    ...
				    <ec:column width="15%" property="dm" title="大厅编号" style="text-align:center" editable="false" />
				    <ec:column width="20%" property="mc" title="大厅名称" style="text-align:center" editable="false" />
				</ec:row>
				<c:if test="${msg != null}">
				<ec:extendrow>
...
<script type="text/javascript">
	function addDepthall(){
		document.form1.action = "toAddDepthall.action"; 
