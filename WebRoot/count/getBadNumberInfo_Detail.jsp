...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
	...
	window.onload = function(){
		...
		function addSeason(){
			document.form1.action="updateBadEvaluationSeason.action";
			...
			<tr>
				...
				<td height="100" style="text-align: center" valign="middle" bgcolor="#f7f7f7">
					<form action="" name="form1" method="post">
						<input type="hidden" name="id" id="id" value="${badevalua.id}"/>
						<table id="myTable" width="60%" border="0" cellpadding="1" cellspacing="1" class="table_back">
				    		...
				    		<tr>
				    			<td width="20%" height="35" bgcolor="#FFFFFF" class="tableheader1">回访人员：</td>
				    			<td width="30%" height="35" bgcolor="#F1F9FD">&nbsp;&nbsp;&nbsp;${badevalua.hfUser}</td>
				    			<td width="20%" height="35" bgcolor="#FFFFFF" class="tableheader1">回访时间：</td>
				    			<td width="30%" height="35" bgcolor="#F1F9FD">&nbsp;&nbsp;&nbsp;${badevalua.jltime}</td>
				    		</tr>
				    		<tr>
				    			<td width="20%" height="35" bgcolor="#FFFFFF" class="tableheader1">差评原因:</td>
				    			<td width="30%" height="35" bgcolor="#F1F9FD" colspan="3">&nbsp;&nbsp;&nbsp;
				    				<textarea id="season" name="season" rows="20" cols="80">${badevalua.season}</textarea>
				    			</td>
				    		</tr>
						</table>
					</form>
					<input id="bt3" name="bt3" class="button" type="button" value=" 保存 " onclick="addSeason()"/>
