...
<%
	List<GuaQiCount> list = (List<GuaQiCount>) request.getAttribute("list");
	...
	%>
		...
		var str1 = "", str2="", str3="";
			<% 
			for (GuaQiCount gqc : list) {
			%>
			str1 += "<category label='<%=gqc.getCode()%>' />";
			str2 += "<set value='<%=gqc.getGqcount()%>' />";
			str3 += "<set value='<%=gqc.getGqyccount()%>' />";
			<%}%>
			var strXML = "<chart xAxisName='' yAxisName='' caption='挂起信息统计' showToolTip='0' shownames='1' showvalues='1' showSum='1' useRoundEdges='1'>";
			strXML += "<categories>"+str1+"</categories>";
			strXML += "<dataset seriesName='挂起数量' color='' showValues=''>"+str2+"</dataset>";
			strXML += "<dataset seriesName='异常数量' color='' showValues=''>"+str3+"</dataset></chart>";
...
function query() { 
	...
	document.form1.action = "guaqitj.action";
	document.form1.submit();
}
function hpExport(obj){
	window.location.href="/queue/count/guaQi_Count_Export_excel.jsp";
    return true;
}
function queryAll(code){
	document.form1.action = "gqInfoListOrDetail.action?code="+code;
	document.form1.submit();
}
function checkEmpty(){
	var result=false;
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td height="51" valign="middle"  background="/queue/images/t-2.jpg">
    	<span style="font-family:'黑体', '宋体';font-size:18px; color:#fff;padding-left:15px;letter-spacing: 10px;letter-spacing: 10px;">挂起信息统计</span>
    </td>
    		...
    		<table id="ec_table" class="tableRegion" width="98%" align="center" border="0" cellpadding="0" cellspacing="0">
	    		<thead id="ec_table_head">
	    			<tr>
	    				...
	    				<td valign="middle" style="text-align:center"  width="10%" class="tableHeader" onmouseover="ECSideUtil.lightHeader(this,'ec');" onmouseout="ECSideUtil.unlightHeader(this,'ec');"><div class="headerTitle" >员工姓名</div></td>
	    				<td valign="middle" style="text-align:center"  width="10%" class="tableHeader" onmouseover="ECSideUtil.lightHeader(this,'ec');" onmouseout="ECSideUtil.unlightHeader(this,'ec');"><div class="headerTitle" >挂起数量</div></td>
	    				<td valign="middle" style="text-align:center"  width="10%" class="tableHeader" onmouseover="ECSideUtil.lightHeader(this,'ec');" onmouseout="ECSideUtil.unlightHeader(this,'ec');"><div class="headerTitle" >挂起异常数量</div></td>
	    				<td valign="middle" style="text-align:center"  width="10%" class="tableHeader" onmouseover="ECSideUtil.lightHeader(this,'ec');" onmouseout="ECSideUtil.unlightHeader(this,'ec');"><div class="headerTitle" >挂起平均时间</div></td>
	    				<td valign="middle" style="text-align:center"  width="10%" class="tableHeader" onmouseover="ECSideUtil.lightHeader(this,'ec');" onmouseout="ECSideUtil.unlightHeader(this,'ec');"><div class="headerTitle" >操作</div></td>
	    			</tr>
	    		</thead>
	    			...
	    			<c:forEach items="${list}" var="item" varStatus="status">
	    				<c:if test="${(status.index%2)!=0}">
	    					<tr  style="text-align:center">
		    					...
		    					<td class="even" style="text-align:center"  width="10%" onmouseover="moveInTdLight(this)" onmouseout="moveOutTdUnLight(this)">${item.gqcount}</td>
		    					<td class="even" style="text-align:center"  width="10%" onmouseover="moveInTdLight(this)" onmouseout="moveOutTdUnLight(this)">${item.gqyccount}</td>
		    					<td class="even" style="text-align:center"  width="10%" onmouseover="moveInTdLight(this)" onmouseout="moveOutTdUnLight(this)">${item.ave}</td>
		    					<td class="even" style="text-align:center"  width="10%" onmouseover="moveInTdLight(this)" onmouseout="moveOutTdUnLight(this)">${item.operation}</td>
		    				</tr>
	    				</c:if>
		    			<c:if test="${(status.index%2)==0}">
	    					<tr  style="text-align:center">
		    					...
		    					<td class="odd" style="text-align:center"  width="10%" onmouseover="moveInTdLight(this)" onmouseout="moveOutTdUnLight(this)">${item.gqcount}</td>
		    					<td class="odd" style="text-align:center"  width="10%" onmouseover="moveInTdLight(this)" onmouseout="moveOutTdUnLight(this)">${item.gqyccount}</td>
		    					<td class="odd" style="text-align:center"  width="10%" onmouseover="moveInTdLight(this)" onmouseout="moveOutTdUnLight(this)">${item.ave}</td>
		    					<td class="odd" style="text-align:center"  width="10%" onmouseover="moveInTdLight(this)" onmouseout="moveOutTdUnLight(this)">${item.operation}</td>
		    				</tr>
	    				</c:if>	
	    			</c:forEach>
	    		</tbody>
				...
				<td> 
					<ec:table items="list" var="list" 
							...
							<ec:row style="text-align:center">
								<ec:column width="7%" property="code" title="员工编号" style="text-align:center" editable="false" />
								<ec:column width="7%" property="xm" title="员工姓名" style="text-align:center" editable="false" />
								<ec:column width="8%" property="gqcount" title="挂起数量" style="text-align:center" editable="false" />
								<ec:column width="8%" property="gqyccount" title="挂起异常数量" style="text-align:center" editable="false" />
								<ec:column width="8%" property="ave" title="挂起平均时间" style="text-align:center" editable="false" />
								<ec:column width="7%" property="operation" title="操作" style="text-align:center" editable="false" />
							</ec:row>
							<c:if test="${msg != null}">
								<ec:extendrow>
