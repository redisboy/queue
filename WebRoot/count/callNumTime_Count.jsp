...
<%
	List<CallNumTimeCount> list = (List<CallNumTimeCount>) request.getAttribute("list");
	...
	%>
		window.onload=function(){
			...
			<% for (CallNumTimeCount qwc : list) {%>
			str1 += "<set value='<%=qwc.getBarid()%>' />";
			str2 += "<set value='<%=qwc.getCode()%>' />";
			str3 += "<set value='<%=qwc.getName()%>' />";
			str4 += "<set value='<%=qwc.getAve()%>' />";
			<%}%>
			var strXML = "<chart xAxisName='' yAxisName='' caption='叫号间隔时间统计' showToolTip='0' shownames='1' showvalues='1' showSum='1' useRoundEdges='1'>";
			strXML += "<dataset seriesName='窗口号' color='' showValues=''>"+str2+"</dataset>";
			strXML += "<dataset seriesName='工号' color='' showValues=''>"+str2+"</dataset>";
			strXML += "<dataset seriesName='姓名' color='' showValues=''>"+str3+"</dataset>";
			strXML += "<dataset seriesName='平均间隔时间(分)' color='' showValues=''>"+str4+"</dataset></chart>";
...
function query() { 
	...
	document.form1.action = "jhsjtj.action";
	document.form1.submit();
}
/*
function hpExport(obj){
	window.location.href="/queue/count/queueWait_Count_Export_excel.jsp";
    return true;
}*/
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td height="51" valign="middle"  background="/queue/images/t-2.jpg">
    	<span style="font-family:'黑体', '宋体';font-size:18px; color:#fff;padding-left:15px;letter-spacing: 10px;letter-spacing: 10px;">叫号间隔时间统计</span>
    </td>
    		...
    		<table id="ec_table" class="tableRegion" width="98%" align="center" border="0" cellpadding="0" cellspacing="0">
	    		<thead id="ec_table_head">
	    			<tr>
	    				...
	    				<td valign="middle" style="text-align:center"  width="10%" class="tableHeader" onmouseover="ECSideUtil.lightHeader(this,'ec');" onmouseout="ECSideUtil.unlightHeader(this,'ec');"><div class="headerTitle" >工号</div></td>
	    				<td valign="middle" style="text-align:center"  width="10%" class="tableHeader" onmouseover="ECSideUtil.lightHeader(this,'ec');" onmouseout="ECSideUtil.unlightHeader(this,'ec');"><div class="headerTitle" >姓名</div></td>
	    				<td valign="middle" style="text-align:center"  width="10%" class="tableHeader" onmouseover="ECSideUtil.lightHeader(this,'ec');" onmouseout="ECSideUtil.unlightHeader(this,'ec');"><div class="headerTitle" >平均间隔时间(分)</div></td>
	    			</tr>
	    		</thead>
				...
				<td> 
					<ec:table items="list" var="list" 
							...
							<ec:row style="text-align:center">
								...
								<ec:column width="8%" property="code" title="工号" style="text-align:center" editable="false" />
								<ec:column width="10%" property="name" title="姓名" style="text-align:center" editable="false" />
								<ec:column width="10%" property="ave" title="平均间隔时间(分)" style="text-align:center" editable="false" />
							</ec:row>
							<c:if test="${msg != null}">
								<ec:extendrow>
