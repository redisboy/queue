...
<%
	List<AgentNjCount> list = (List<AgentNjCount>) request.getAttribute("list");
...
function query() { 
	...
	document.form1.action = "njdj.action";
	document.form1.submit();
}
function hpExport(obj){
	window.location.href="count/njWait_Count_Export_excel.jsp";
    return true;
}
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td height="51" valign="middle"  background="/queue/images/t-2.jpg">
    	<span style="font-family:'黑体', '宋体';font-size:18px; color:#fff;padding-left:15px;letter-spacing: 10px;letter-spacing: 10px;">年检登记查询</span>
    </td>
    ...
    <form action="" method="post" name="form1">
     <input name="flag" id="flag" type="hidden" value="1"/>
          <table width="90%" border="0" cellpadding="1" cellspacing="1" class="table_back">
            <tr>
              <td width="15%" height="25" bgcolor="#FFFFFF" class="tableheader1">身份证号码</td>
              <td  width=150 bgColor=#f1f9fd height=30>&nbsp;
              <input name="idcard" id="idcard" type="text" class="inputface"/>
	          </td>
	          <td width="10%" height="25" bgcolor="#FFFFFF" class="tableheader1">名字</td>
              <td  width=150 bgColor=#f1f9fd height=30>&nbsp;
              <input name="name" id="name" type="text" class="inputface"/>
	          </td>
              <td width="15%" height="25" bgcolor="#FFFFFF" class="tableheader1">起始时间</td>
              <td  width=150 bgColor=#f1f9fd height=30>&nbsp;
	         <%
            ...
            <td class=tableheader1  width=15% height=30>结束时间:</td>
          	<td  width=150 bgColor=#f1f9fd height=30>&nbsp;
	          <%
          		if(null!=ksrq && !ksrq.equals("")){
          	 %>
	...
	<td> 
		<ec:table items="list" var="list" 
				...
				<ec:row style="text-align:center">
					...
					<ec:column width="17%" property="name" title="代理人姓名" style="text-align:center" editable="false" />
					<ec:column width="17%" property="validity" title="有效期止" style="text-align:center" editable="false" />
					<ec:column width="17%" property="checkdate" title="年检时间" style="text-align:center" editable="false" />
					<ec:column width="17%" property="pid" title="操作员警号" style="text-align:center" editable="false" />
					<ec:column width="17%" property="code" title="办理业务" style="text-align:center" editable="false" />
				</ec:row>
