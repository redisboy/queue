...
function hpExport(obj){
	window.location.href="/queue/count/idNumberCount_Export_excel.jsp";
    return true;
}
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td height="51" valign="middle"  background="/queue/images/t-2.jpg">
    	<span style="font-family:'黑体', '宋体';font-size:18px; color:#fff;padding-left:15px;letter-spacing: 10px;letter-spacing: 10px;">证件号码取号次数统计</span>
    </td>
     ...
     <input name="deptHall" id="deptHall" type="hidden" value="<%=deptHall %>">
          <table width="80%" border="0" cellpadding="1" cellspacing="1" class="table_back">
           ...
           <select name="tjms" id="tjms" >
            ...
            <td class=tableheader1 width=10% height=30>统计人员:</td>
           <td width=150 bgColor=#f1f9fd height=30>&nbsp;
           <select name="tjry" id="tjry" >
              		<option value="0">车主证件</option>
				  	<option value="1">代办人证件</option>
            </select>
            </td>
	...
	<td> 
		<ec:table items="list" var="list" 
				...
				<ec:row style="text-align:center">
					<ec:column width="15%" property="_0" title="序号" style="text-align:center" value="${GLOBALROWCOUNT}" editable="false" sortable="false"/>
					<ec:column width="55%" property="IDNumber" title="证件号码" style="text-align:center" editable="false" />
					<ec:column width="30%" property="idnumbercount" title="取号次数" style="text-align:center" editable="false" />
				</ec:row>
				<c:if test="${msg != null}">
				<ec:extendrow>
