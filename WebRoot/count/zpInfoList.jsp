...
function query() { 
	...
	document.form1.action = "queryAllPhoto.action";
	document.form1.submit();
}
function hpExport(obj){
	window.location.href="count/zpInfoList_Export_excel.jsp";
    return true;
}
function queryDetail(id){
	document.form1.action = "queryAllPhoto.action?id="+id;
	document.form1.submit();
}
...
function checkEmpty(){
	...
	var operNum=document.getElementById("operNum").attributes["value"].value;
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td height="51" valign="middle"  background="/queue/images/t-2.jpg">
    	<span style="font-family:'黑体', '宋体';font-size:18px; color:#fff;padding-left:15px;letter-spacing: 10px;letter-spacing: 10px;">照片信息查询</span>
    </td>
           ...
           <select name="tjms" id="tjms" >
            ...
            <tr>
            	<td width="10%" height="25" bgcolor="#FFFFFF" class="tableheader1">窗口号:</td>
              	...
              	<td class=tableheader1 width=10% height=30>员工编号:</td>
              	<td width=150 bgColor=#f1f9fd height=30>&nbsp;
              		<input id="operNum" name="operNum" class="inputface"/>
              	</td>
              	<td class=tableheader1 width=10% height=30>身份证:</td>
              	<td width=150 bgColor=#f1f9fd height=30>&nbsp;
              		<input id="IDNumber" name="IDNumber" class="inputface"/>
              	</td>
            </tr>
          </table>
	...
	<td> 
		<ec:table items="list" var="list" 
				...
				<ec:row style="text-align:center">
					...
					<ec:column width="7%" property="IDNumber" title="车主证件号码" style="text-align:center" editable="false" />
					<ec:column width="7%" property="IDNumberB" title="代办人证件号码" style="text-align:center" editable="false" />
					<ec:column width="10%" property="enterTime" title="取号时间" style="text-align:center" editable="false" />
					<ec:column width="10%" property="beginTime" title="叫号时间" style="text-align:center" editable="false" />
					<ec:column width="10%" property="sfzphotoStr" title="身份证照片" style="text-align:center" editable="false" />
					<ec:column width="7%" property="quhaoPhotoStr" title="取号照片" style="text-align:center" editable="false" />
					<ec:column width="7%" property="photoBase64Str" title="业务办理照片" style="text-align:center" editable="false" />
					<ec:column width="3%" property="operation" title="操 作" style="text-align:center" editable="false" />
				</ec:row>
				<c:if test="${msg != null}">
				<ec:extendrow>
