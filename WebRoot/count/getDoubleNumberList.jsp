...
<script type="text/javascript">
	function detailAll(idnumber){
		document.form1.action = "qhxxyjxq.action?idnumber="+idnumber;
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td height="51" valign="middle"  background="/queue/images/t-2.jpg">
    	<span style="font-family:'黑体', '宋体';font-size:18px; color:#fff;padding-left:15px;letter-spacing: 10px;letter-spacing: 10px;">取号信息预警</span>
    </td>
