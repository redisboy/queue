...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td height="51" valign="middle"  background="/queue/images/t-2.jpg">
    	<span style="font-family:'黑体', '宋体';font-size:18px; color:#fff;padding-left:15px;letter-spacing: 10px;letter-spacing: 10px;">代理人排队统计</span>
    </td>
	...
	<td> 
		<ec:table items="list" var="list" 
				...
				<ec:row style="text-align:center">
					...
					<ec:column width="10%" property="id" title="资格证编号" style="text-align:center" editable="false" />
					<ec:column width="10%" property="name" title="代理人姓名" style="text-align:center" editable="false" />
					<ec:column width="10%" property="idcard" title="身份证编号" style="text-align:center" editable="false" />
					<ec:column width="8%" property="x1" title="机动车(次)" style="text-align:center" editable="false" />
					<ec:column width="8%" property="x2" title="驾驶证（次）" style="text-align:center" editable="false" />
					<ec:column width="8%" property="x4" title="违法（次）"style="text-align:center" editable="false" />
				</ec:row>
