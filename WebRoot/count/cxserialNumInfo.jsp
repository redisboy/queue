...
function query() { 
	...
	document.form1.action = "getBarId.action";
	document.form1.submit();
}
function hpExport(obj){
	window.location.href="cxserialNumInfo_Export_excel.jsp";
    return true;
}
...
function checkEmpty(){
	...
	var cxhm=document.getElementById("cxhm").attributes["value"].value;
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td height="51" valign="middle"  background="/queue/images/t-2.jpg">
    	<span style="font-family:'黑体', '宋体';font-size:18px; color:#fff;padding-left:15px;letter-spacing: 10px;letter-spacing: 10px;">顺序号详细信息查询</span>
    </td>
     ...
     <input name="flag" id="flag" type="hidden" value="1"/>
          <table width="80%" border="0" cellpadding="1" cellspacing="1" class="table_back">
           ...
           <select name="tjms" id="tjms" >
            ...
            <td class=tableheader1 width=10% height=30>顺序号:</td>
          	<td width=150 bgColor=#f1f9fd height=30>&nbsp;
	          	<input name="cxhm" id="cxhm" type="text" class="inputface" style="text-transform: uppercase;" value=""/>
           </td>
           <td class=tableheader1 width=10% height=30>身份证:</td>
           <td width=150 bgColor=#f1f9fd height=30>&nbsp;
           		<input name="IDNumber" id="IDNumber" type="text" class="inputface" style="text-transform: uppercase;" value=""/>
           </td>
            </tr>
            <tr>
            </tr>
	...
	<td> 
		<ec:table items="list" var="list" 
				...
				<ec:row style="text-align:center">
					...
					<ec:column width="7%" property="xm" title="姓名" style="text-align:center" editable="false" />
					<ec:column width="7%" property="barId" title="窗口号" style="text-align:center" editable="false" />
					<ec:column width="7%" property="serialNum" title="顺序号" style="text-align:center" editable="false" />
					...
					<ec:column width="14%" property="IDNumber" title="车主证件号码" style="text-align:center" editable="false" />
					<ec:column width="14%" property="IDNumberB" title="代办人证件号码" style="text-align:center" editable="false" />
					<ec:column width="7%" property="czyh" title="取号操作用户" style="text-align:center" editable="false" />
					<ec:column width="10%" property="rztime" title="操作时间" style="text-align:center" editable="false" />
				</ec:row>
				<c:if test="${msg != null}">
				<ec:extendrow>
