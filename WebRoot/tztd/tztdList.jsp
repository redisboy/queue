...
function query() { 
	...
	document.form1.action = "getTztdAll.action?lrrq="+lrrq+"&idnumber"+idnumber;
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td height="51" valign="middle"  background="/queue/images/t-2.jpg">
    	<span style="font-family:'黑体', '宋体';font-size:18px; color:#fff;padding-left:15px;letter-spacing: 10px;letter-spacing: 10px;">提档通知查询</span>
    </td>
    ...
    <form action="" method="post" name="form1">
     <input name="flag" id="flag" type="hidden" value="1"/>
          <table width="80%" border="0" cellpadding="1" cellspacing="1" class="table_back">
            ...
            <td class=tableheader1 width=10% height=30>身份证号:</td>
          	<td width=150 bgColor=#f1f9fd height=30>&nbsp;
	...
	<td> 
		<ec:table items="list" var="list" 
				...
				<ec:row style="text-align:center">
					...
					<ec:column width="10%" property="operate" title="操作" style="text-align:center" editable="false" />
				</ec:row>
				<c:if test="${msg != null}">
				<ec:extendrow>
