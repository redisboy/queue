...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="/queue/window/js/tv_queue_led_nanning.js"></script>
...
//			$("#nowDate").html(y+"年"+(m>9?m:("0"+m))+"月"+(d>9?d:("0"+d))+"日  "+h+":"+i+":"+s); 
	...
	<body scroll="no">
		<div class="inner tv" name="top_u1" id="top_u1" style="margin-left:0px;position:absolute;left:0;top:0;background:#145b7d;">
			<table id="tab1" class="tab1">
				<tr>
					<td id="" class="border_b td1" style="width:100%;font-size:60px;color:red"><P>业  务  等  待  提  醒</P></td>
				</tr>
				<tr>					
					<td id="" rowspan="1" class="border_r" style="vertical-align:top;height:35%;color:#feeeed;">
						<ul name="date_u1" id="date_u1">
							<!--<li style='font-size: 65px;width: 100%;text-align:justify;text-justify:distribute-all-lines;text-align-last:justify'>A0001号请到12号窗口办理</li>
							<li style='font-size: 65px;width: 100%;text-align:justify;text-justify:distribute-all-lines;text-align-last:justify'>A0001号请到12号窗口办理</li>
							<li style='font-size: 65px;width: 100%;text-align:justify;text-justify:distribute-all-lines;text-align-last:justify'>A0001号请到12号窗口办理</li>
							<li style='font-size: 65px;width: 100%;text-align:justify;text-justify:distribute-all-lines;text-align-last:justify'>A0001号请到12号窗口办理</li>
							<li style='font-size: 65px;width: 100%;text-align:justify;text-justify:distribute-all-lines;text-align-last:justify'>A0001号请到12号窗口办理</li>
