...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="/queue/window/js/tv_queue_led_chengdu_yisuo.js"></script>
...
//			$("#nowDate").html(y+"年"+(m>9?m:("0"+m))+"月"+(d>9?d:("0"+d))+"日  "+h+":"+i+":"+s); 
		...
		*{margin:0;padding:0;}html{height:100%;}
		...
		.border_r{border-right:1px solid #f00;}.title{font-size:27px;height:10%;}
		.td1{height:6%;}.td2{height:6%;}.td3{vertical-align:top;height:77%;}.td4{height:6%;}
		.td5{height:78%;vertical-align:top;}
		-->
		</style>
	</head>
	<body scroll="no">
		<div class="inner tv" name="top_u1" id="top_u1" style="margin-left:512px;position:absolute;left:0;top:0;background:#000;">
			<table id="tab1" class="tab1">
				<tr>
					<td id="hallname" colspan="3" class="border_b title"></td>
				</tr>
				<tr>
					<td class="border_b td1" colspan="3">
						<marquee id="gdxx" scrollamount="2" style="font-size:14px;width:60%"></marquee>
						<span id="nowDate" style="font-size:14px;width:40%"></span>
					</td>
					<!-- <td class="border_b td1" colspan="3"><marquee id="gdxx" scrollamount="2" style="font-size:14px"></marquee></td>
					<td id="nowDate" colspan="3" class="border_b td1" style="font-size:10px"></td> -->
				</tr>
				<tr>
					<td id="title1" colspan="1" class="border_b td1" style="width:35%;font-size:14px"></td>
					<td id="title2" colspan="1" class="border_b td1" style="width:35%;font-size:14px"></td>
					<td id="title3" colspan="1" class="border_b td1" style="width:30%;font-size:14px"></td>
				</tr>
				<tr>
					<td id="" rowspan="1" colspan="1" class="border_r" style="vertical-align:top;">
						<marquee height="236px" vspace="5" hspace="5" align="right" scrollamount="2" direction = "up" behavior = "scroll">
							<div id="content1" style='layout-grid:	15.6pt;'></div>
						</marquee>
					</td>
					<td id="content22" rowspan="1" colspan="1" class="border_r" style="vertical-align:top;">
					...
					<td id="" class="td3 border_b" colspan="1" rowspan="1" style="vertical-align:top;">
						<marquee height="236px" vspace="5" hspace="5" align="right" scrollamount="2" direction = "up" behavior = "scroll">
