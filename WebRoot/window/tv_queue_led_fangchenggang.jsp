...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="/queue/window/js/tv_queue_led_fangchenggang.js"></script>
	...
	<body scroll="no">
		<div class="inner tv" name="top_u1" id="top_u1" style="position:absolute;left:0;top:0;background:#000;">
			<table id="tab1" class="tab1">
				...
				<tr>
					<td id="title1" class="border_b td1" style="width:30%;font-size:14px"></td>
					<td id="title2" class="border_b td1" style="width:30%;font-size:14px"></td>
					<td class="border_b td1" style="width:40%;font-size:14px">满意度信息</td>
				</tr>
				<tr>
					...
					<td id="" rowspan="1" class="border_r" style="vertical-align:top;">
						<div style="width:100%;height:328px;float:left;text-align:center;">
							<table class="tab1" style="height:100%;width:100%;">
								<tr>
									<td style="font-size:13px;width:34%;height:10%;border-right:1px solid red;border-bottom:1px solid red;">警员</td>
									<td style="font-size:13px;width:33%;border-right:1px solid red;border-bottom:1px solid red;border-left:1px solid red;">满意率</td>
									<td style="font-size:13px;width:33%;border-bottom:1px solid red;border-left:1px solid red;">评价量</td>
								</tr>
								<tr>
