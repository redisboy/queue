...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="/queue/window/js/tv_queue_led_wulanchabu.js"></script>
...
//			$("#nowDate").html(y+"年"+(m>9?m:("0"+m))+"月"+(d>9?d:("0"+d))+"日  "+h+":"+i+":"+s); 
		...
		*{margin:0;padding:0;}html{height:100%;}
		...
		.border_r{border-right:1px solid #f00;}.title{font-size:60px;height:10%;}
	...
	<body scroll="no">
		<div class="inner tv" name="top_u1" id="top_u1" style="position:absolute;left:0;top:0;background:#000;">
			<table id="tab1" class="tab1">
				...
				<tr>
					<td class="border_b td1" colspan="2"><marquee id="gdxx" scrollamount="2" style="font-size:24px"></marquee></td>
					<td id="nowDate" class="border_b td1" style="font-size:24px"></td>
				</tr>
				<tr>
					<td id="title1" class="border_b td1" style="width:40%;font-size:24px"></td>
					<td id="title2" class="border_b td1" style="width:20%;font-size:24px"></td>
					<td id="title3" class="border_b td1" style="width:40%;font-size:24px"></td>
				</tr>
				<tr>
					<td id="" rowspan="1" class="border_r" style="vertical-align:top;">
						<marquee height=550 vspace="5" hspace="5" align="right" scrollamount="2" direction = "up" behavior = "scroll">
					...
					<td id="" class="td3 border_b" rowspan="1" style="vertical-align:top;">
						<marquee height=550px vspace="5" hspace="5" align="right" scrollamount="2" direction = "up" behavior = "scroll">
