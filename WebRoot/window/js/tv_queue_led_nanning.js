...
//    ou2.append(newLi);
    ...
    var newLi1 = "<li id='" + liId1 + "' style='width:100%;list-style:none;border-bottom: none;line-height:25px;height:25px;font-size: 25px;'>"+data.serialNum.toLocaleUpperCase()+"号请到"+data.winNum+"号窗口办理</li>";
