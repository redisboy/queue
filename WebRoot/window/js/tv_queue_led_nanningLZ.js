...
//    ou2.append(newLi);
    ...
    var newLi1 = "<li id='" + liId1 + "' style='width:100%;list-style:none;border-bottom: none;line-height:25px;height:22px;font-size: 25px;'>"+data.serialNum.toLocaleUpperCase()+"号请到"+data.winNum+"号窗口</li>";
...
//	if(lzxxNum%2==0){
		...
		var newLi2 = "<li id='" + liId2 + "' style='font-size: 68px;width: 100%;text-align:justify;text-justify:distribute-all-lines;text-align-last:justify'>"+xm+"请到"+data.barid+"号窗口领证</li>";
