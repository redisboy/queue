...
//    var ou3 = $('#date_u3');
	    ...
	    var newLi = "<li id='" + liId + "' style='width:100%;list-style:none;border-bottom: none;line-height:23px;height:23px;font-size: 23px;'>"+data.serialNum.toLocaleUpperCase()+"号请到"+data.winNum+"号窗口</li>";
	    if (9 <= ou2.find("li").length) {
	        ou2.find("li:first").remove();
	    }
	    ou2.append(newLi);
