...
if(data.winNum < 10){
    ...
    var newLi = "<li id='" + liId + "' style='width:100%;list-style:none;border-bottom: none;line-height:26px;height:24px;font-size: 24px;'>"+data.serialNum.toLocaleUpperCase()+"号请到"+data.winNum+"号窗口</li>";
    if (21 <= ou2.find("li").length) {
    ...
    var newLi1 = "<li id='" + liId1 + "' style='width:100%;list-style:none;border-bottom: none;line-height:26px;height:24px;font-size: 24px;'>"+data.serialNum.toLocaleUpperCase()+"号请到"+data.winNum+"号窗口</li>";
    if (21 <= ou1.find("li").length) {
