...
//	if(lzxxNum%2==0){
		...
		var newLi2 = "<li id='" + liId2 + "' style='width:100%;list-style:none;border-bottom: none;line-height:33px;height:32px;font-size: 32px;'>"+xm+"请到"+data.barid+"号窗口</li>";
...
if(data.winNum < 10){
    ...
    if(num%3==1){
	    ...
	    var newLi = "<li id='" + liId + "' style='width:100%;list-style:none;border-bottom: none;line-height:33px;height:32px;font-size: 32px;'>"+data.serialNum.toLocaleUpperCase()+"号请到"+data.winNum+"号窗口</li>";
	    if (8 <= ou2.find("li").length) {
	        ou2.find("li:first").remove();
	    }
	    ou2.append(newLi);
    ...
    if(num%3==2){
	    ...
	    var newLi1 = "<li id='" + liId1 + "' style='width:100%;list-style:none;border-bottom: none;line-height:33px;height:32px;font-size: 32px;'>"+data.serialNum.toLocaleUpperCase()+"号请到"+data.winNum+"号窗口</li>";
    ...
    if(num%3==0){
	    ...
	    var newLi2 = "<li id='" + liId2 + "' style='width:100%;list-style:none;border-bottom: none;line-height:33px;height:32px;font-size: 32px;'>"+data.serialNum.toLocaleUpperCase()+"号请到"+data.winNum+"号窗口</li>";
	    if (8 <= ou3.find("li").length) {
