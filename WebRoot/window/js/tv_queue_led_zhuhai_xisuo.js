	...
	$.ajax({
        ...
        success: function(data) {
			...
			for(var i=0;i<ywAndddrs.length;i++){
				...
				$("#ywmc").append("<li style='font-size:18px;width:100%;height:32px;' id='"+ywAndddrs[i].id+"name'>"+ywAndddrs[i].name+"</li>");
				$("#ddrs").append("<li style='font-size:18px;width:100%;height:32px' id='"+ywAndddrs[i].id+"ddrs'>"+ywAndddrs[i].ddrs+"</li>");
				$("#nextNum").append("<li style='font-size:18px;width:100%;height:32px'  id='"+ywAndddrs[i].id+"nextNum'></li>");
			}
			//遍历窗口号及业务量到页面
			...
			for(var i=0;i<screenAndywl.length;i++){
				...
				$("#windowNum").append("<li style='font-size:18px;width:100%;height:32px' id='"+screenAndywl[i].windowNum+"winNum'>"+screenAndywl[i].windowNum+"</li>");
				$("#ywl").append("<li style='font-size:18px;width:100%;height:32px' id='"+screenAndywl[i].windowNum+"ywl'>"+screenAndywl[i].ywl+"</li>");
				$("#hm").append("<li style='font-size:18px;width:100%;height:32px' id='"+screenAndywl[i].windowNum+"hm'></li>");
