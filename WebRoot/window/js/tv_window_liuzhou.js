...
if(data.winNum < 10){
    ...
    var newLi = "<li id='" + liId + "' style='font-size: 108px;width: 66%;text-align:justify;text-justify:distribute-all-lines;text-align-last:justify'>"+data.serialNum.toLocaleUpperCase()+"号请到"+data.winNum+"号窗口</li>";
