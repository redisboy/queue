...
if(data.winNum < 10){
    ...
    var newLi1 = "<li id='" + liId1 + "' style='width:100%;list-style:none;border-bottom: none;line-height:19px;height:18px;font-size: 18px;'>"+data.serialNum.toLocaleUpperCase()+"号到"+data.winNum+"号窗口</li>";
    if (12 <= ou1.find("li").length) {
