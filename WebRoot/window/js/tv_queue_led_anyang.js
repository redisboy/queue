...
function showLzxx(data) {
	    ...
	    var newLi1 = "<li id='" + liId1 + "' style='height:30px;font-size: 30px;width: 33%;text-align:justify;text-justify:distribute-all-lines;text-align-last:justify'>"+xm+"请到"+data.barid+"号窗口领证&nbsp;&nbsp;&nbsp;&nbsp;</li>";
	    if (30 <= ou1.find("li").length) {
...
if(data.winNum < 10){
    ...
    var newLi1 = "<li id='" + liId1 + "'style='height:30px;font-size: 30px;width: 33%;text-align:justify;text-justify:distribute-all-lines;text-align-last:justify'>"+data.serialNum.toLocaleUpperCase()+"请到"+data.winNum+"号窗口办理&nbsp;&nbsp;&nbsp;&nbsp;</li>";
    if (30 <= ou1.find("li").length) {
        ou1.find("li:first").remove();
    }
    ou1.append(newLi1);
