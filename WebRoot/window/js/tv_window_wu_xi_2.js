...
//	data.winNum = "0"+data.winNum;
    ...
    var newLi = "<li id='" + liId + "' style='font-size: 98px;width: 53%;text-align:justify;text-justify:distribute-all-lines;text-align-last:justify'>"+data.serialNum.toLocaleUpperCase()+"号请到"+data.winNum+"号窗口</li></c:if>";
