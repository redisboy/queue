...
if(data.winNum=='2C' || data.winNum=='2D' || data.winNum=='2E' || data.winNum=='2F'){
//	data.winNum = "0"+data.winNum;

    var oul = $('#date_u1');
    var liId = data.serialNum + "" + data.winNum;
    var newLi = "<li id='" + liId + "' style='font-size: 103px;width: 100%;text-align:justify;text-justify:distribute-all-lines;text-align-last:justify'>"+data.serialNum.toLocaleUpperCase()+"号请到"+data.winNum+"号窗口</li></c:if>";
