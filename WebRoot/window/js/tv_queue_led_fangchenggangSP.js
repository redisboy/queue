...
function showLzxx(data) {
	    ...
	    var newLi1 = "<li id='" + liId1 + "' style='width:100%;list-style:none;border-bottom: none;line-height:25px;height:25px;font-size:25px;'>"+xm+"请到"+data.barid+"号窗口领证</li>";
	    if (11 <= ou1.find("li").length) {
...
if(data.winNum < 10){
    ...
    var newLi1 = "<li id='" + liId1 + "' style='width:100%;list-style:none;border-bottom: none;line-height:30px;height:30px;font-size:30px;'>"+data.serialNum.toLocaleUpperCase()+"号请到"+data.winNum+"号窗口</li>";
