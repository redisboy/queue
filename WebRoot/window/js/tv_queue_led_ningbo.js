...
if(data.winNum < 10){
    ...
    var newLi = "<li id='" + liId + "' style='width:100%;list-style:none;border-bottom: none;line-height:14px;height:12px;font-size: 12px;'>"+data.serialNum.toLocaleUpperCase()+"号请到"+data.winNum+"号窗口</li>";
    ...
    var newLi1 = "<li id='" + liId1 + "' style='width:100%;list-style:none;border-bottom: none;line-height:14px;height:12px;font-size: 12px;'>"+data.serialNum.toLocaleUpperCase()+"号请到"+data.winNum+"号窗口</li>";
    if (16 <= ou1.find("li").length) {
