...
//	if(lzxxNum%2==0){
		...
		var newLi2 = "<li id='" + liId2 + "' style='width:100%;list-style:none;border-bottom: none;line-height:20px;height:20px;font-size: 20px;'>"+xm+"请到"+data.barid+"号窗口</li>";
	    if (15 <= ou2.find("li").length) {
...
function showMessage(data) {
	if(data.winNum < 15){
	    ...
	    var newLi1 = "<li id='" + liId1 + "' style='width:100%;list-style:none;border-bottom: none;line-height:19px;height:18px;font-size: 20px;'>"+data.serialNum.toLocaleUpperCase()+"号到"+data.winNum+"号窗口</li>";
