...
data.winNum = "0"+data.winNum;
   ...
   var ou1 = $('#date_u1');
    ...
    var newLi1 = "<li id='" + liId1 + "' style='width:100%;list-style:none;border-bottom: none;line-height:25px;height:18px;font-size: 25px;'>"+data.serialNum.toLocaleUpperCase()+"号到"+data.winNum+"号窗口</li>";
