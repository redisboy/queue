...
//	if(lzxxNum%2==0){
		...
		var newLi2 = "<li id='" + liId2 + "' style='width:100%;list-style:none;border-bottom: none;line-height:34px;height:33px;font-size: 33px;'>"+xm+"请到"+data.barid+"号</li>";
	    if (7 <= ou2.find("li").length) {
...
if(data.winNum < 10){
    ...
    if(num%2==1){
	    ...
	    var newLi = "<li id='" + liId + "' style='width:100%;list-style:none;border-bottom: none;line-height:34px;height:33px;font-size: 33px;'>"+data.serialNum.toLocaleUpperCase()+"号请到"+data.winNum+"号</li>";
	    if (7 <= ou2.find("li").length) {
	        ou2.find("li:first").remove();
	    }
	    ou2.append(newLi);
    ...
    if(num%2==0){
	    ...
	    var newLi2 = "<li id='" + liId2 + "' style='width:100%;list-style:none;border-bottom: none;line-height:34px;height:33px;font-size: 33px;'>"+data.serialNum.toLocaleUpperCase()+"号请到"+data.winNum+"号</li>";
	    if (7 <= ou1.find("li").length) {
	        ou1.find("li:first").remove();
	    }
	    ou1.append(newLi2);
	    setTimeout(function() {
