...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="/queue/window/js/tv_queue_led_nanning_pj.js"></script>
...
//			$("#nowDate").html(y+"年"+(m>9?m:("0"+m))+"月"+(d>9?d:("0"+d))+"日  "+h+":"+i+":"+s); 
	...
	<body scroll="no">
		<div class="inner tv" name="top_u1" id="top_u1" style="margin-left:700px;position:absolute;left:0;top:0;background:#000;">
			<table id="tab1" class="tab1">
				...
				<tr>
					<td id="title1" class="border_b td1" style="width:50%;font-size:14px"></td>
					<td class="border_b td1" style="width:50%;font-size:14px">满意度信息</td>
				</tr>
				<tr>
					...
					<td id="" rowspan="1" class="border_r" style="vertical-align:top;">
						<div style="width:100%;height:340px;float:left;text-align:center;">
