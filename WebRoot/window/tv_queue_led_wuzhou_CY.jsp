...
<script type="text/javascript"
	src="/queue/window/js/tv_queue_led_wuzhou_CY.js"></script>
<script type="text/javascript">
...
<body scroll="no">
	<div class="inner tv" name="top_u1" id="top_u1"
		style="position:absolute;left:0;top:0;background:#000;">
		<table id="tab1" class="tab1">
			<tr>
				<td id="" class="border_b td1" style="width:25%;height:20px;font-size:24px">小型汽车</td>
				<td id="" class="border_b td1" style="width:25%;height:20px;font-size:24px">小型汽车</td>
				<td id="" class="border_b td1" style="width:25%;height:20px;font-size:24px">大型汽车</td>
				<td id="" class="border_b td1" style="width:25%;height:20px;font-size:24px">大型汽车</td>
			</tr>
			<tr>
				<!-- <td  rowspan="1" class="border_r td3"
					style="vertical-align:top;">
					<ul name="date_u1" id="date_u1">
					<li style="width:100%;text-align:left;list-style:none;border-bottom: none;line-height:13px;height:14px;font-size: 14px;">A0002号请到2号窗口</li>
					</ul>
				</td> -->
			...
			<tr>
				<td colspan="4" id="" class="border_r td4" style="text-align:left;font-size:48px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;机动车大厅查验综合屏</td>
				
			</tr>
			<tr>
				<td colspan="4" class="border_r td5"
					style="vertical-align:top;">
					<ul name="date_u1" id="date_u1">
