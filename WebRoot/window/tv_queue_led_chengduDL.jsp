...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="/queue/window/js/tv_queue_led_chengduDL.js"></script>
...
//			$("#nowDate").html(y+"年"+(m>9?m:("0"+m))+"月"+(d>9?d:("0"+d))+"日  "+h+":"+i+":"+s); 
		...
		*{margin:0;padding:0;}html{height:100%;}
		...
		.td1{height:10%;}.td2{height:90%;}.td3{vertical-align:top;height:36%;}.td4{height:6%;}
		.td5{height:36%;vertical-align:top;}
		-->
		</style>
	</head>
	<body scroll="no">
		<div class="inner tv" name="top_u1" id="top_u1" style="margin-left:527px;position:absolute;left:0;top:0;background:#000;">
			<table id="tab1" class="tab1">
				<tr>
					<!-- <td id="title1" class="border_b td1" style="width:40%;font-size:14px"></td> -->
					<td id="title2" class="border_b td1" style="font-size:14px"><P>排队信息<br/>Queuing Information</P></td>
					<!-- <td id="title3" class="border_b td1" style="width:40%;font-size:14px"></td> -->
				</tr>
				<tr>
					...
					<td id="content2" rowspan="1" class="border_r td2" style="vertical-align:top;">
						<ul name="date_u1" id="date_u1">
							<!-- <li style='width:100%;list-style:none;border-bottom: none;line-height:20px;height:18px;font-size: 18px;'>A0001号到12号窗口</li>
							<li style='width:100%;list-style:none;border-bottom: none;line-height:20px;height:18px;font-size: 18px;'>A0001号到12号窗口</li> -->
							<li style='width:100%;list-style:none;border-bottom: none;line-height:20px;height:18px;font-size: 18px;'>A0001号到12号窗口</li>
							<li style='width:100%;list-style:none;border-bottom: none;line-height:20px;height:18px;font-size: 18px;'>A0001号到12号窗口</li>
							<li style='width:100%;list-style:none;border-bottom: none;line-height:20px;height:18px;font-size: 18px;'>A0001号到12号窗口</li>
