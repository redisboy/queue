...
//			$("#nowDate").html(y+"年"+(m>9?m:("0"+m))+"月"+(d>9?d:("0"+d))+"日  "+h+":"+i+":"+s); 
	...
	<body scroll="no">
		<div class="inner tv" name="top_u1" id="top_u1" style="margin-left:780px;position:absolute;left:0;top:0;background:#000;">
			<table id="tab1" class="tab1">
				<tr>
					<td id="" class="border_b td1" style="width:30%;font-size:32px;color:#00e3e3"><P>业务办理等候提示</P></td>
				</tr>
				<tr>
					<div class="showWaitRs" id="showWaitRs"><!-- 存放等待人数 -->
					<td id="" class="border_b td1" style="width:30%;font-size:32px;color:yellow"><P>当前等待人数：32人</P></td>
				</tr>
				<tr>					
					<td id="" rowspan="1" class="border_r" style="vertical-align:top;height:35%">
