...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="/queue/window/js/tv_queue_led_gy_jinyang.js"></script>
	...
	<body scroll="no">
		<div class="inner tv" name="top_u1" id="top_u1" style="position:absolute;left:0;top:0;background:#000;">
			<table id="tab1" class="tab1">
				...
				<tr><!-- 贵阳金阳 -->
					<td id="title1" class="border_b td1" style="width:38%;font-size:20px"></td>
					<td id="title2" class="border_b td1" style="width:24%;font-size:20px"></td>
					<td id="title3" class="border_b td1" style="width:38%;font-size:20px"></td>
				</tr>
				<tr>
					<td id="" rowspan="1" class="border_r" style="vertical-align:top;">
						<marquee height=460 vspace="5" hspace="5" align="right" scrollamount="2" direction = "up" behavior = "scroll"><!-- 金阳模式 -->
							<div id="content1" style='layout-grid:15.6pt;'></div>
						</marquee>
					</td>
					<td id="content2" rowspan="1" class="border_r" style="vertical-align:top;">
						<ul name="date_u1" id="date_u1">
						 <!-- <li style='width:100%;list-style:none;border-bottom: none;line-height:19px;height:18px;font-size: 20px;'>A0002号请到12号窗口</li>
					...
					<td id="" class="td3 border_b" rowspan="1" style="vertical-align:top;">
						<marquee height=460  px vspace="5" hspace="5" align="right" scrollamount="2" direction = "up" behavior = "scroll">  <!-- 金阳模式 -->
