...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="/queue/window/js/tv_queue_led_yinchuan.js"></script>
		...
		<div class="inner tv" name="top_u1" id="top_u1" style="position:absolute;left:0;top:0;background:#000;">
			<table id="tab1" class="tab1">
				<tr>
			 	...
			 	<tr>
					<td class="border_b td1" colspan="1"><marquee id="gdxx" scrollamount="2" style="font-size:14px"></marquee></td>
					<td id="nowDate" class="border_b td1" style="text-align: right;font-size:14px"></td>
				</tr>
				<tr>
					<td id="title1" class="border_b td1" style="width:40%;font-size:14px"></td>
					<td id="title2" class="border_b td1" style="width:20%;font-size:14px"></td>
					<!-- <td id="title3" class="border_b td1" style="width:40%;font-size:14px">3333</td>-->
				</tr>
				<tr style="width:45%;vertical-align:top;text-align:left;">
					<td id="" rowspan="1" class="border_r" style="width:45%;vertical-align:top;text-align:left;">
							<div id="lzxx" style='float:left;layout-grid:15.6pt;'>
									
							</div>
					</td>	
					<td id="" rowspan="1" class="border_r" style="width:55%;vertical-align:top;">
