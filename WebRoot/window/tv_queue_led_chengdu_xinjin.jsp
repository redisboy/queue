...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="/queue/window/js/tv_queue_led_chengdu_xinjin.js"></script>
	...
	<body scroll="no">
		<div class="inner tv" name="top_u1" id="top_u1" style="position:absolute;left:0;top:0;background:#000;">
			<table id="tab1" class="tab1">
				...
				<tr>
					<td id="title1" colspan="1" class="border_b td1" style="width:30%;font-size:14px"></td>
					<td id="title2" colspan="1" class="border_b td1" style="width:40%;font-size:14px"></td>
