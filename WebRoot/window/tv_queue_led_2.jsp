	...
	<body scroll="no">
		<div class="inner tv" name="top_u1" id="top_u1" style="position:absolute;left:0;top:0;background:#000;">
			<table id="tab1" class="tab1">
				...
				<tr>
					<td class="border_b td1" colspan="2"><marquee id="gdxx"></marquee></td>
					<td id="nowDate" class="border_b td1" style="font-size:14px"></td>
				</tr>
				<tr>
					<td id="title1" class="border_b td2" style="width:25%;"></td>
					<td id="title2" class="border_b td2" style="width:30%;"></td>
					<td id="title3" class="border_b td2" style="width:45%;"></td>
				</tr>
				<tr>
					<td id="content1" rowspan="3" class="border_r" style="vertical-align:top;"></td>
					<td id="content2" rowspan="3" class="border_r" style="vertical-align:top;">
						<ul name="date_u1" id="date_u1">
							<li style='width:100%;list-style:none;border-bottom: none;'>A0001号请到12号窗口</li>
							<li style='width:100%;list-style:none;border-bottom: none;'>A0001号请到12号窗口</li>
							<li style='width:100%;list-style:none;border-bottom: none;'>A0001号请到12号窗口</li>
							<li style='width:100%;list-style:none;border-bottom: none;'>A0001号请到12号窗口</li>
							<li style='width:100%;list-style:none;border-bottom: none;'>A0001号请到12号窗口</li>
					...
					<td id="content3" class="td3 border_b"></td>
				</tr>
				<tr>
					<td id="title4" class="td4 border_b"></td>
				</tr>
				<tr>
					<td id="content4" class="td5"></td>
				</tr>
			</table>
