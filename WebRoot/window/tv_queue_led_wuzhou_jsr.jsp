...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="/queue/window/js/tv_queue_led_wuzhou_jsr.js"></script>
	...
	<body scroll="no" >
		<div class="inner tv" name="top_u1" id="top_u1" style="margin-left:0px;position:absolute;left:0;top:0;background:#000;">
			<table id="tab1" class ="tab1">
				<tr>
					<td colspan="3" rowspan="1" class="td11" style="font-size: 18px">领证信息</td>
					<td colspan="1" rowspan="1" class="td11">排队信息</td>
					<td colspan="1" rowspan="1" class="td11">排队信息</td>
					<td colspan="3" rowspan="1" class="td11">各窗口业务办理信息</td>
				</tr>
				<tr>
					<td colspan="3" rowspan="2" style="width: 22%;vertical-align:top;">
					<ul name="date_u0" id="date_u0" ></ul>
					</td>
