...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="/queue/window/js/tv_queue_led_zhongshan_ZHP.js"></script>
	...
	<body scroll="no" >
		<div class="inner tv" name="top_u1" id="top_u1" style="margin-left:0px;position:absolute;left:0;top:0;background:#000;">
			<table id="tab1" class ="tab1">
				<tr>
					<td colspan="3" rowspan="1" class="td11" id="ddrssum" style="font-size: 20px">各业务等待总数:0人</td>
					<td colspan="1" rowspan="1" class="td11">警务公开</td>
					<!-- <td id="title3" class="border_b td1" style="width:36%;font-size:22px"></td> -->
					<td colspan="1" rowspan="1" class="td11">排队信息</td>
					<td colspan="2" rowspan="1" class="td11">各窗口业务办理信息</td>
					<td colspan="1" rowspan="1" class="td11">温馨提示</td>
				</tr>
				<tr>
					<td colspan="1" rowspan="1" class="td12" style="width: 25%">业务名称</td>
					<td colspan="1" rowspan="1" class="td12" style="width: 5%">等待量</td>
					<td colspan="1" rowspan="1" class="td12" style="width: 8%">预叫号</td>
					
					<td colspan="1" rowspan="2" style="width: 22%;vertical-align:top;">
						<marquee height=288 vspace="5" hspace="5" align="right" scrollamount="2" direction = "up" behavior = "scroll">
					...
					<td colspan="1" rowspan="1" class="td12" style="width: 5%">窗口号</td>
					<td colspan="1" rowspan="1" class="td12" style="width: 5%">业务办理量</td>		
					<td colspan="1" rowspan="2" style="width: 8%;vertical-align:top;">
						<!--	<marquee height=288 vspace="5" hspace="5" align="right" scrollamount="2" direction = "up" behavior = "scroll">-->
				...
				<tr>
					...
					<td colspan="1" rowspan="1" class="td13">
						<marquee height=258 vspace="5" hspace="5" align="right" scrollamount="2" direction = "up" behavior = "scroll">
								<div id="windowNum" style='font-size:20px;width:100%;height:24px'></div>
						</marquee>
					<!--	<ul id="windowNum"></ul>-->
					</td>
					<td colspan="1" rowspan="1" class="td13">
						<marquee height=258 vspace="5" hspace="5" align="right" scrollamount="2" direction = "up" behavior = "scroll">
							<div id="ywl" style='font-size:20px;width:100%;height:24px'></div>
					</marquee>
