...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="/queue/window/js/tv_queue_led_zhuhai_zongsuo.js"></script>
...
//			$("#nowDate").html(y+"年"+(m>9?m:("0"+m))+"月"+(d>9?d:("0"+d))+"日  "+h+":"+i+":"+s); 
		...
		*{margin:0;padding:0;}html{height:100%;}
		...
		td{border:1px solid red} .td11 {height:8%;text-align: center;font-size: 19px}.td12 {height:8%;text-align: center;font-size: 15px}.td13 {height:83%;text-align: center;vertical-align:top;}
	...
	<body scroll="no" >
		<div class="inner tv" name="top_u1" id="top_u1" style="margin-left:0px;position:absolute;left:0;top:0;background:#000;">
			<table id="tab1" class ="tab1">
				<tr>
					<td colspan="3" rowspan="1" class="td11" style="font-size: 18px">各业务等待人数</td>
					<td colspan="1" rowspan="1" class="td11">排队信息</td>
					<td colspan="1" rowspan="1" class="td11">排队信息</td>
					<td colspan="3" rowspan="1" class="td11">各窗口业务办理信息</td>
				</tr>
				<tr>
					<td colspan="1" rowspan="1" class="td12" style="width: 12%">业务名称</td>
					<td colspan="1" rowspan="1" class="td12" style="width: 8%">等待量</td>
					<td colspan="1" rowspan="1" class="td12" style="width: 8%">预叫号</td>
					<td colspan="1" rowspan="2" style="width: 22%;vertical-align:top;">
						<ul name="date_u1" id="date_u1" >
<!-- 							<li id='1' style='font-size:20px;width:100%;text-align:center;height:24px'><font color='red'>A0001</font>号到<font color='red'>01</font>窗</li> -->
<!-- 							<li id='1' style='font-size:20px;width:100%;text-align:center;height:24px'><font color='red'>A0001</font>号到<font color='red'>01</font>窗</li> -->
<!-- 							<li id='1' style='font-size:20px;width:100%;text-align:center;height:24px'><font color='red'>A0001</font>号到<font color='red'>01</font>窗</li> -->
<!-- 							<li id='1' style='font-size:20px;width:100%;text-align:center;height:24px'><font color='red'>A0001</font>号到<font color='red'>01</font>窗</li> -->
<!-- 							<li id='1' style='font-size:20px;width:100%;text-align:center;height:24px'><font color='red'>A0001</font>号到<font color='red'>01</font>窗</li> -->
...
<!-- 							<li id='1' style='font-size:20px;width:100%;text-align:center;height:24px'><font color='red'>A0001</font>号到<font color='red'>01</font>窗</li> -->
<!-- 							<li id='1' style='font-size:20px;width:100%;text-align:center;height:24px'><font color='red'>A0001</font>号到<font color='red'>01</font>窗</li> -->
<!-- 							<li id='1' style='font-size:20px;width:100%;text-align:center;height:24px'><font color='red'>A0011</font>号到<font color='red'>01</font>窗</li> -->
<!-- 							<li id='1' style='font-size:20px;width:100%;text-align:center;height:24px'><font color='red'>A0011</font>号到<font color='red'>01</font>窗</li> -->
<!-- 							<li id='1' style='font-size:20px;width:100%;text-align:center;height:24px'><font color='red'>A0011</font>号到<font color='red'>01</font>窗</li> -->
<!-- 							<li id='1' style='font-size:20px;width:100%;text-align:center;height:24px'><font color='red'>A0011</font>号到<font color='red'>01</font>窗</li> -->
<!-- 							<li id='1' style='font-size:20px;width:100%;text-align:center;height:24px'><font color='red'>A0015</font>号到<font color='red'>01</font>窗</li> -->
<!-- 							<li id='1' style='font-size:20px;width:100%;text-align:center;height:24px'><font color='red'>A0017</font>号到<font color='red'>01</font>窗</li> -->
<!-- 							<li id='1' style='font-size:20px;width:100%;text-align:center;height:24px'><font color='red'>A0017</font>号到<font color='red'>01</font>窗</li> -->
<!-- 							<li id='1' style='font-size:20px;width:100%;text-align:center;height:24px'><font color='red'>A0018</font>号到<font color='red'>01</font>窗</li> -->
						</ul>
					</td>
					<td colspan="1" rowspan="2" style="width: 22%;vertical-align:top;">
...
<!-- 							<li id='1' style='font-size:20px;width:100%;text-align:center;height:24px'><font color='red'>A0017</font>号到<font color='red'>01</font>窗</li> -->
					...
					<td colspan="1" rowspan="1" class="td12" style="width: 8%">窗口号</td>
					<td colspan="1" rowspan="1" class="td12" style="width: 12%">业务办理量</td>
					<td colspan="1" rowspan="1" class="td12" style="width: 8%">当前号</td>
				</tr>
				<tr>
					<td colspan="1" rowspan="1" class="td13">
						<ul id="ywmc"></ul>
					</td>
					<td colspan="1" rowspan="1" class="td13">
						<ul id="ddrs"></ul>
