...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="/queue/window/js/tv_queue_led_xinhui.js"></script>
	...
	<body scroll="no">
		<div class="inner tv" name="top_u1" id="top_u1" style="position:absolute;left:0;top:0;background:#000;">
			<table id="tab1" class="tab1">
				...
				<tr>
					<td id="title1" class="border_b td1" style="width:50%;font-size:15px"></td>
					<td id="title2" class="border_b td1" style="width:50%;font-size:15px"></td>
					<td  class="border_b td1" style="width:0%;font-size:14px"></td>
					<!-- <td id="title3" class="border_b td1" style="width:40%;font-size:18px">公告信息</td> -->
				</tr>
				<tr>
				<td id="" rowspan="1" class="border_r" style="vertical-align:top;">
						<div id="content1">
							<ul name="date_u1" id="date_u1">
								<!--<li style='width:100%;list-style:none;border-bottom: none;line-height:25px;height:18px;font-size: 25px;'>A0001号到1号窗口</li>
								<li style='width:100%;list-style:none;border-bottom: none;line-height:25px;height:18px;font-size: 25px;'>A0001号到1号窗口</li>
								<li style='width:100%;list-style:none;border-bottom: none;line-height:25px;height:18px;font-size: 25px;'>A0001号到1号窗口</li>
								<li style='width:100%;list-style:none;border-bottom: none;line-height:25px;height:18px;font-size: 25px;'>A0001号到1号窗口</li>
								<li style='width:100%;list-style:none;border-bottom: none;line-height:25px;height:18px;font-size: 25px;'>A0001号到1号窗口</li>
					...
					<td id="" class="td3 border_b" rowspan="1" style="vertical-align:top;">
						<marquee height=285px vspace="5" hspace="5" align="right" scrollamount="2" direction = "up" behavior = "scroll">
							<div id="content2" style='layout-grid:15.6pt;'></div>
						</marquee>
					</td>
