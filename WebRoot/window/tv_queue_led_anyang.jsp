...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="/queue/window/js/tv_queue_led_anyang.js"></script>
	...
	<body scroll="no">
		<div class="inner tv" name="top_u1" id="top_u1" style="margin-left:0px;position:absolute;left:0;top:0;background:#000;">
			<table id="tab1" class="tab1">
				<tr>
					<td id="title2" class="border_b td1" style="height:40px;width:100%;font-size:36px;" align="center"></td>
				</tr>
				<tr>
					<td id="content1" rowspan="1" class="border_r td4" style="vertical-align:top;width: 100%;">
			...
			<table id="tab2" class="tab1">
				<tr>
					<td id="title1" class="border_b td1" style="height:40px;width:100%;font-size:36px;" align="center"></td>
				</tr>
				<tr>
					<td id="content2" rowspan="1" class="border_r td4" style="vertical-align:top;width: 100%;">
