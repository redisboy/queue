...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="/queue/window/js/tv_queue_led_guigang.js"></script>
	...
	<body scroll="no">
		<div class="inner tv" name="top_u1" id="top_u1" style="margin-left:0px;position:absolute;left:0;top:0;background:#000;">
			<table id="tab1" class="tab1">
				<tr>
					<td id="title1" colspan="1" class="border_b td1" style="width:50%;font-size:26px">排队信息</td>
					<td id="title2" colspan="1" class="border_b td1" style="width:50%;font-size:26px">领证信息</td>
					<!-- <td id="title3" colspan="1" class="border_b td1" style="width:25%;font-size:32px">排队信息</td>
					<td id="title4" colspan="1" class="border_b td1" style="width:25%;font-size:32px">领证信息</td> -->
				</tr>
				<tr>
					<td id="content1" rowspan="1" class="border_r td4" style="vertical-align:top;width: 50%;">
						<ul name="date_u1" id="date_u1">
							<!-- <li style='width:100%;list-style:none;border-bottom: none;line-height:23px;height:23px;font-size: 23px;'>A0001号请到12号窗口</li>
							<li style='width:100%;list-style:none;border-bottom: none;line-height:23px;height:23px;font-size: 23px;'>A0001号请到12号窗口</li>
							<li style='width:100%;list-style:none;border-bottom: none;line-height:23px;height:23px;font-size: 23px;'>A0001号请到12号窗口</li>
							<li style='width:100%;list-style:none;border-bottom: none;line-height:23px;height:23px;font-size: 23px;'>A0010号请到12号窗口</li>
							<li style='width:100%;list-style:none;border-bottom: none;line-height:23px;height:23px;font-size: 23px;'>A0011号请到12号窗口</li>
							<li style='width:100%;list-style:none;border-bottom: none;line-height:23px;height:23px;font-size: 23px;'>A0012号请到12号窗口</li>
							<li style='width:100%;list-style:none;border-bottom: none;line-height:23px;height:23px;font-size: 23px;'>A0013号请到12号窗口</li>
							<li style='width:100%;list-style:none;border-bottom: none;line-height:23px;height:23px;font-size: 23px;'>A0014号请到12号窗口</li> -->
						</ul>
					</td>
					<td id="content2" rowspan="1" class="border_r td4" style="vertical-align:top;width: 50%;">
