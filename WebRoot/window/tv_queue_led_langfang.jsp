...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="/queue/window/js/tv_queue_led_langfang.js"></script>
		...
		function getCurDate()
			{
			 ...
			 var ndate = years+"-"+month+"-"+days+"<br/> "+hours+":"+minutes+":"+seconds+"<br/>"+week;
	...
	<body scroll="no">
		<div class="inner tv" name="top_u1" id="top_u1" style="margin-left:0px;position:absolute;left:0;top:0;background:#000;">
			<table id="tab1" class="tab1">
				<tr>
					<td id="content3" rowspan="1" class="border_r td4" style="vertical-align:top;width: 12%;">
					<br />
					<br />
					<br />
					<br /><br /><br />
						<p id="nowDate" style="font-size:45px"></p>
					</td>
					<td id="content4" rowspan="1" class="border_r td4" style="vertical-align:top;width: 13%;">
						<p style="font-size:50px" align="center">今日值班</p><br /><br />
						<p style="font-size:40px" align="left">姓名:高静<br/>职务:民警<br/>电话:5768820</p>
					</td>
					<td id="content1" rowspan="1" class="border_r td4" style="vertical-align:top;width: 25%;">
						<ul name="date_u1" id="date_u1">
							<!-- <li style='width:100%;list-style:none;border-bottom: none;line-height:35px;height:33px;font-size: 33px;'>A0001号请到12号窗口办理业务</li>
							<li style='width:100%;list-style:none;border-bottom: none;line-height:35px;height:33px;font-size: 33px;'>A0001号请到12号窗口办理业务</li>
							<li style='width:100%;list-style:none;border-bottom: none;line-height:35px;height:33px;font-size: 33px;'>A0001号请到12号窗口办理业务</li>
							<li style='width:100%;list-style:none;border-bottom: none;line-height:35px;height:33px;font-size: 33px;'>A0010号请到12号窗口办理业务</li>
							<li style='width:100%;list-style:none;border-bottom: none;line-height:35px;height:33px;font-size: 33px;'>A0011号请到12号窗口办理业务</li>
							<li style='width:100%;list-style:none;border-bottom: none;line-height:35px;height:33px;font-size: 33px;'>A0012号请到12号窗口办理业务</li>
							<li style='width:100%;list-style:none;border-bottom: none;line-height:35px;height:33px;font-size: 33px;'>A0013号请到12号窗口办理业务</li>
							<li style='width:100%;list-style:none;border-bottom: none;line-height:35px;height:33px;font-size: 33px;'>A0014号请到12号窗口办理业务</li>
							<li style='width:100%;list-style:none;border-bottom: none;line-height:35px;height:33px;font-size: 33px;'>A0014号请到12号窗口办理业务</li> -->
						</ul>
					</td>
