...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="/queue/window/js/tv_queue_led_zhuhai_xisuoLz.js"></script>
...
//			$("#nowDate").html(y+"年"+(m>9?m:("0"+m))+"月"+(d>9?d:("0"+d))+"日  "+h+":"+i+":"+s); 
		...
		*{margin:0;padding:0;}html{height:100%;}
		...
		.border_r{border-right:1px solid #f00;}.title{font-size:28px;height:8%;}
	...
	<body scroll="no">
		<div class="inner tv" name="top_u1" id="top_u1" style="margin-left:0px;position:absolute;left:0;top:0;background:#000;">
			<table id="tab1" class="tab1">
				<tr>
					<td id="title1" colspan="1" class="border_b td1" style="width:34%;font-size:20px"></td>
					<td id="title2" colspan="1" class="border_b td1" style="width:33%;font-size:20px">排队信息</td>
					<td id="title4" colspan="1" class="border_b td1" style="width:33%;font-size:20px">领证信息</td>
				</tr>
				<tr>
					...
					<td id="content2" rowspan="1" class="border_r" style="vertical-align:top;width: 33%;">
