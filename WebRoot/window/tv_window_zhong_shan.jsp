...
li {list-style:none;}
	...
	border-bottom: none;
		...
		<script type="text/javascript" src="/queue/window/js/tv_window_zhong_shan.js"></script>
	...
	<body scroll="no" onload="onload()">
		...
		<div class="inner tv" name="top_u1" id="top_u1" style="display:none;position:relative;background:#000;">
			<ul class="ul_1" name="date_u1" id="date_u1" style="left:10px;top:0;color:#f00;" ></ul>
		</div>
