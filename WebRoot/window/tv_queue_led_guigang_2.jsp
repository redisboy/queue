...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="/queue/window/js/tv_queue_led_guigang_2.js"></script>
		...
		window.onload = function(){
			...
			$("#title3").html(title3);
			if("排队信息"==title3){$("#content3").html("<ul name='date_u3' id='date_u3'></ul>");}
			else if("领证信息"==title3){$("#content3").html("<ul name='date_u3' id='date_u3'></ul>");}else{$("#content3").html(content3);}
			$("#title4").html(title4);
				...
				<tr>
					<td colspan="3">
						<table style="width:100%">
							<tr>
								<td class="border_b td1" colspan="2" style="width:60%"><marquee id="gdxx" scrollamount="2" style="font-size:14px"></marquee></td>
								<td id="nowDate" class="border_b td1" style="width:40%;font-size:14px"></td>
							</tr>
						</table>
					</td>
				</tr>
				<tr>
					<td id="title1" class="border_b td1" style="width:35%;font-size:14px"></td>
					<td id="title2" class="border_b td1" style="width:35%;font-size:14px"></td>
					<td class="border_b td1" style="width:30%;font-size:14px">满意度信息</td>
				</tr>
				<tr>
					<td id="content1" rowspan="1" class="border_r td3" style="vertical-align:top;">
					...
					<td id="content2" rowspan="1" class="border_r td3" style="vertical-align:top;">
					...
					<td id="" rowspan="1" class="border_r" style="vertical-align:top;">
						<div style="width:100%;height:215px;float:left;text-align:center;">
							<table class="tab1" style="height:100%;width:100%;">
								<tr>
									<td style="font-size:13px;width:34%;height:10%;border-right:1px solid red;border-bottom:1px solid red;">受理窗口</td>
									<td style="font-size:13px;width:33%;border-right:1px solid red;border-bottom:1px solid red;border-left:1px solid red;">差评次数</td>
								</tr>
								<tr>
									<td style="font-size:13px;height:85%;border-top:1px solid red;vertical-align:top">
										<ul id="ck">
											<li id='notr' style='font-size:15px;text-align:center;'>暂无差评窗口</li>
										</ul>
									</td>
									<td  style="height:85%;border-top:1px solid red;vertical-align:top">
										<ul id="cp">
										</ul>
									</td>
								</tr>
					...
					<!--<td id="" class="td3 border_b" rowspan="1" style="vertical-align:top;">
						<marquee height=285px vspace="5" hspace="5" align="right" scrollamount="2" direction = "up" behavior = "scroll">
							<div id="content4" style='layout-grid:15.6pt;'></div>
						</marquee>
					</td>-->
				</tr>
			</table>
