...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="/queue/window/js/tv_queue_led_nanningLZ.js"></script>
...
//			$("#nowDate").html(y+"年"+(m>9?m:("0"+m))+"月"+(d>9?d:("0"+d))+"日  "+h+":"+i+":"+s); 
	...
	<body scroll="no">
		<div class="inner tv" name="top_u1" id="top_u1" style="position:absolute;left:0;top:0;background:#145b7d;">
			<table id="tab1" class="tab1" border="0" cellpadding="0" cellspacing="0">				
				<tr>
					<td id="" class="border_b td1" style="width:100%;font-size:60px;color:red"><P>证  件  领  取  信  息  提  示</P></td>
				</tr>
				<tr>	
					<td id="" class="td3 border_b" rowspan="1" style="vertical-align:top;color:#feeeed;">
						<ul name="date_u2" id="date_u2">
							<!--<li style='font-size: 68px;width: 100%;text-align:justify;text-justify:distribute-all-lines;text-align-last:justify'>A0001号请到12号窗口领证</li>
							<li style='font-size: 68px;width: 100%;text-align:justify;text-justify:distribute-all-lines;text-align-last:justify'>A0001号请到12号窗口领证</li>
							<li style='font-size: 68px;width: 100%;text-align:justify;text-justify:distribute-all-lines;text-align-last:justify'>A0001号请到12号窗口领证</li>
							<li style='font-size: 68px;width: 100%;text-align:justify;text-justify:distribute-all-lines;text-align-last:justify'>A0001号请到12号窗口领证</li>
							<li style='font-size: 68px;width: 100%;text-align:justify;text-justify:distribute-all-lines;text-align-last:justify'>A0001号请到12号窗口领证</li>
							...
							<li style='font-size: 68px;width: 100%;text-align:justify;text-justify:distribute-all-lines;text-align-last:justify'>A0001号请到12号窗口领证</li>
							<li style='font-size: 68px;width: 100%;text-align:justify;text-justify:distribute-all-lines;text-align-last:justify'>A0001号请到12号窗口领证</li>
							<li style='font-size: 68px;width: 100%;text-align:justify;text-justify:distribute-all-lines;text-align-last:justify'>A0001号请到13号窗口领证</li>-->
						</ul>
						
						
						
						<!-- <marquee height=460 vspace="5" hspace="5" align="right" scrollamount="2" direction = "up" behavior = "scroll">
