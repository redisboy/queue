...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="/queue/window/js/tv_queue_led_wuzhou.js"></script>
...
//			else if("领证信息"==title2){$("#content2").html("<ul name='lzxx' id='lzxx'></ul>");}else{$("#content2").html(content2);}
		...
		*{margin:0;padding:0;}html{height:100%;}
		...
		.border_b{border-bottom:1px solid #f00;text-align:center}.border_l{border-left:1px solid #f00;}
		.border_r{border-right:1px solid #f00;}.title{font-size:50px;height:10%;}
		.td1{height:6%;}.td2{height:6%;}.td3{vertical-align:top;height:36%;}.td4{height:78%;}
		.td5{height:36%;vertical-align:top;}
		td{border:1px solid red} .td11 {height:8%;text-align: center;font-size: 30px}.td12 {height:8%;text-align: center;font-size: 25px}.td13 {height:83%;text-align: center;vertical-align:top;}
	...
	<body scroll="no" >
		<div class="inner tv" name="top_u1" id="top_u1" style="margin-left:0px;position:absolute;left:0;top:0;background:#000;">
			<table id="tab1" class ="tab1">
				<tr>
					<td id="hallname" colspan="5" class="border_b title" ></td>
				</tr>
				<tr>
					<td colspan="5">
						<table style="width:100%">
							<tr>
								<td class="border_b td1" colspan="2" style="width:50%"><marquee id="gdxx" scrollamount="2" style="font-size:30px"></marquee></td>
								<td id="nowDate" class="border_b td1" style="width:50%;font-size:30px"></td>
							</tr>
						</table>
					</td>
				</tr>
				<tr>
					<td colspan="3" rowspan="1" class="td11" id="ddrssum" style="font-size: 30px">各业务等待总数:0人</td>
				...
				<tr>
					...
					<td colspan="1" rowspan="2" style="width: 32%;vertical-align:top;">
						<marquee height=420 vspace="5" hspace="5" align="right" scrollamount="2" direction = "up" behavior = "scroll">
							<div id="content3" style='layout-grid:15.6pt;font-size: 24px'></div>
						</marquee>
					</td>
					<td colspan="1" rowspan="2" style="width: 32%;vertical-align:top;">
