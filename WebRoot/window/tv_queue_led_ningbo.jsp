...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="/queue/window/js/tv_queue_led_ningbo.js"></script>
...
//			$("#nowDate").html(y+"年"+(m>9?m:("0"+m))+"月"+(d>9?d:("0"+d))+"日  "+h+":"+i+":"+s); 
		...
		*{margin:0;padding:0;}html{height:100%;}
		...
		.border_t{border-right:1px solid #f00;border-left:1px solid #f00;}
		.border_r{border-right:1px solid #f00;}.title{font-size:18px;height:10%;}
	...
	<body scroll="no">
		<div class="inner tv" name="top_u1" id="top_u1" style="position:absolute;left:0;top:0;background:#000;">
			<table id="tab1" class="tab1">
				...
				<!-- <tr>
					<td class="border_b td1" colspan="2" style="width: 74%;"><marquee id="gdxx" scrollamount="2" style="font-size:14px"></marquee></td>
					<td id="nowDate" class="border_b td1" style="font-size:14px;width: 26%;"></td>
				</tr> -->
				<tr>
					<td id="title11" class="border_b td1" style="width:66%;font-size:14px" colspan="2">公告信息</td>
					<td id="title2" class="border_b td1" style="width:34%;font-size:14px">排队信息</td>
				</tr>
				<tr>
					<td id="" rowspan="1" class="border_r" style="width:66%;top;" colspan="2">
						<marquee height=224 vspace="5" hspace="5" align="right" scrollamount="2" direction = "up" behavior = "scroll">
							<div id="content1" style='layout-grid:15.6pt;'></div>
						</marquee>
					</td>
					<td id="content2" rowspan="1" class="border_t" style="vertical-align:top;width: 34%;">
						<ul name="date_u1" id="date_u1">
							<li style='width:100%;list-style:none;border-bottom: none;line-height:20px;height:18px;font-size: 18px;'>A0001号请到12号窗口</li>
							<li style='width:100%;list-style:none;border-bottom: none;line-height:20px;height:18px;font-size: 18px;'>A0001号请到12号窗口</li>
							<li style='width:100%;list-style:none;border-bottom: none;line-height:20px;height:18px;font-size: 18px;'>A0001号请到12号窗口</li>
							<li style='width:100%;list-style:none;border-bottom: none;line-height:20px;height:18px;font-size: 18px;'>A0001号请到12号窗口</li>
							<li style='width:100%;list-style:none;border-bottom: none;line-height:20px;height:18px;font-size: 18px;'>A0001号请到12号窗口</li>
