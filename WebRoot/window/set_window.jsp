...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td height="51" valign="middle"  background="/queue/images/t-2.jpg">
    	<span style="font-family:'黑体', '宋体';font-size:18px; color:#fff;padding-left:15px;letter-spacing: 10px;letter-spacing: 10px;">窗口设置</span>
    </td>
	...
	<td> 
		<ec:table items="list" var="list" 
				...
				<ec:row style="text-align:center">
				    <ec:column width="9%" property="windowId" title="窗口编号" style="text-align:center" editable="false" />
					<ec:column width="9%" property="address" title="LED屏地址" style="text-align:center" editable="false" />
...
<script type="text/javascript">
	function addWindow(){
		document.form1.action = "add.action"; 
		document.form1.submit();

	}
	
	function updateWindow(id){
		document.form1.action = "updateWindow.action?id="+id; 
		document.form1.submit();
	}
	
	function delWindow(id,ip){
		if(confirm("确定删除吗?")){ 
			document.form1.action = "delWindow.action?id="+id+"&ip="+ip;
			document.form1.submit();
		}
	}
</script>
