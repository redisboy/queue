...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="/queue/window/js/tv_queue_led_chengdu.js"></script>
...
//			$("#nowDate").html(y+"年"+(m>9?m:("0"+m))+"月"+(d>9?d:("0"+d))+"日  "+h+":"+i+":"+s); 
		...
		*{margin:0;padding:0;}html{height:100%;}
		...
		<style>
		.marquee {width:285px;height:297px;overflow:hidden;border:1px solid #333;}
		</style>
	...
	<body scroll="no">
		<div class="inner tv" name="top_u1" id="top_u1" style="position:absolute;left:0;top:0;background:#000;">
			<table id="tab1" class="tab1">
				<tr>
					<td id="hallname" colspan="3" class="border_b title"></td>
				</tr>
				<tr>
					<td class="border_b td1" colspan="2"><marquee id="gdxx" scrollamount="2" style="font-size:14px"></marquee></td>
					<td id="nowDate" class="border_b td1" style="font-size:14px"></td>
				</tr>
				<tr>
					<td id="title1" class="border_b td1" style="width:40%;font-size:14px"></td>
					<td id="title2" class="border_b td1" style="width:30%;font-size:14px"></td>
					<td id="title3" class="border_b td1" style="width:30%;font-size:14px"></td>
				</tr>
				<tr>
					<td id="" rowspan="1" class="border_r" style="vertical-align:top;width:40%;font-size:14px">
						<marquee height=285 vspace="5" hspace="5" align="right" scrollamount="2" direction = "up" behavior = "scroll">
							<div id="content1" style='layout-grid:15.6pt;'></div>
						</marquee>
					</td>
					<td id="content2" rowspan="1" class="border_r" style="vertical-align:top;width:30%;font-size:14px">
					...
					<td id="content3" rowspan="1" class="border_r" style="vertical-align:top;width:30%;font-size:14px">
					<div class="marquee">
						<ul name="date_u2" id="date_u2">
								<!-- <li id="1" style='width:100%;list-style:none;border-bottom: none;line-height:19px;height:18px;font-size: 18px;'>A0001号请到1号窗口</li>
								<li id="2" style='width:100%;list-style:none;border-bottom: none;line-height:19px;height:18px;font-size: 18px;'>A0001号请到2号窗口</li>
								<li id="3" style='width:100%;list-style:none;border-bottom: none;line-height:19px;height:18px;font-size: 18px;'>A0001号请到3号窗口</li>
								<li id="4" style='width:100%;list-style:none;border-bottom: none;line-height:19px;height:18px;font-size: 18px;'>A0001号请到4号窗口</li>
								<li id="5" style='width:100%;list-style:none;border-bottom: none;line-height:19px;height:18px;font-size: 18px;'>A0001号请到5号窗口</li>
								<li id="6" style='width:100%;list-style:none;border-bottom: none;line-height:19px;height:18px;font-size: 18px;'>A0001号请到6号窗口</li>
								<li id="7" style='width:100%;list-style:none;border-bottom: none;line-height:19px;height:18px;font-size: 18px;'>A0001号请到7号窗口</li>
								<li id="8" style='width:100%;list-style:none;border-bottom: none;line-height:19px;height:18px;font-size: 18px;'>A0001号请到8号窗口</li>
								<li id="9" style='width:100%;list-style:none;border-bottom: none;line-height:19px;height:18px;font-size: 18px;'>A0001号请到9号窗口</li>
								<li id="10" style='width:100%;list-style:none;border-bottom: none;line-height:19px;height:18px;font-size: 18px;'>A0001号请到10号窗口</li>
								<li id="11" style='width:100%;list-style:none;border-bottom: none;line-height:19px;height:18px;font-size: 18px;'>A0001号请到11号窗口</li>
								<li id="12" style='width:100%;list-style:none;border-bottom: none;line-height:19px;height:18px;font-size: 18px;'>A0001号请到12号窗口</li>
								<li id="13" style='width:100%;list-style:none;border-bottom: none;line-height:19px;height:18px;font-size: 18px;'>A0001号请到13号窗口</li>
								<li id="14" style='width:100%;list-style:none;border-bottom: none;line-height:19px;height:18px;font-size: 18px;'>A0001号请到14号窗口</li>
								<li id="15" style='width:100%;list-style:none;border-bottom: none;line-height:19px;height:18px;font-size: 18px;'>A0001号请到15号窗口</li>
								<li id="16" style='width:100%;list-style:none;border-bottom: none;line-height:19px;height:18px;font-size: 18px;'>A0001号请到16号窗口</li> -->
						</ul>
					</div>
					</td>
				</tr>
