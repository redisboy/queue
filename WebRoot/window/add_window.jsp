	...
	<table width="98%" border="0" align="center" cellpadding="0"
		...
		<tr>
			...
			<td height="51" valign="middle" background="images/t-2.jpg"><span
				style="font-family: '黑体', '宋体'; font-size: 18px; color: #fff; padding-left: 15px; letter-spacing: 10px; letter-spacing: 10px;">添加窗口</span>
			</td>
					...
					<table id="myTable" width="60%" border="0" cellpadding="1"
						...
						<tr>
							...
							<td width="80%" height="35" bgcolor="#F1F9FD">&nbsp; <input
								...
								name="mainWindow" value="1" onclick="isMainWindow(this.value)"
								checked="checked" />否
							</td>
						</tr>
						<tr>
							...
							<td width="20%" height="35" bgcolor="#F1F9FD">&nbsp; <input
								name="windowId" id="windowId" maxlength="10"
								style="width: 100px" onkeyup="clearNoNum(this)"
								onafterpaste="clearNoNum(this)" /> &nbsp;<font id="winc"
						...
						<tr>
							<td width="20%" height="35" bgcolor="#FFFFFF"
								class="tableheader1">特殊窗口高</td>
							<td width="20%" height="35" bgcolor="#F1F9FD">&nbsp; <input
								name="ledWindowHeight" id="ledWindowHeight" maxlength="10"
								style="width: 100px" onkeyup="clearNoNum(this)"
								onafterpaste="clearNoNum(this)" /> &nbsp;<font id="winc"
								color="#ff0000">*有特殊窗口设置</font>
							</td>
						</tr>
						<tr>
							<td width="20%" height="35" bgcolor="#FFFFFF"
								class="tableheader1">特殊窗口宽</td>
							<td width="20%" height="35" bgcolor="#F1F9FD">&nbsp; <input
						...
						<tr>
							...
							<td width="80%" height="35" bgcolor="#F1F9FD">&nbsp; <input
								name="address" id="address" style="width: 100px"
						...
						<tr>
							...
							<td width="80%" height="35" bgcolor="#F1F9FD">&nbsp; <input
								...
								style="width: 100px" /> &nbsp;<font id="ipinfo" color="#ff0000"></font>
							</td>
						</tr>
						<tr>
							<td width="20%" height="35" bgcolor="#FFFFFF"
							...
							<td width="80%" height="35" bgcolor="#F1F9FD">&nbsp; <input
								...
								style="width: 100px" /> &nbsp;<font color="#ff0000">没有时为空,窗口选择双行!</font>
							</td>
						</tr>
						<tr>
							<td width="20%" height="35" bgcolor="#FFFFFF"
							...
							<td width="80%" height="35" bgcolor="#F1F9FD">&nbsp; <select
								name="defaultvalue" id="defaultvalue">
									<c:forEach var="ValueRecord" items="${valuelist}"
										varStatus="vs">
										<option value="${ValueRecord.id }">${ValueRecord.name }
										</option>
									</c:forEach>
							</select>
							</td>
						...
						<tr>
							...
							<td width="80%" height="35" bgcolor="#F1F9FD"><c:forEach
									var="Business" items="${list1}" varStatus="vs">
									<input type="checkbox" name="business" value="${Business.id}" />${Business.id}：${Business.name}
									</c:forEach> <input type="checkbox" title="全选"
								onclick="checkboxCheckedAll('business')" />全选</td>
						<tr>
							<td width="20%" height="35" bgcolor="#FFFFFF"
						...
						<tr>
							...
							<td width="80%" height="35" bgcolor="#F1F9FD"
								...
								name="showNum" value="1" checked />单行 <input type="radio"
						...
						<tr>
							...
							<td width="80%" height="35" bgcolor="#F1F9FD">&nbsp; <input
								type="radio" name="openInterFace" value="0" checked />是 <input
						...
						<tr>
							...
							<td width="80%" height="35" bgcolor="#F1F9FD">&nbsp; <input
								...
								style="width: 200px" /> <input type="radio" value="0"
								name="isgd" checked="checked" />是&nbsp; <input type="radio"
								value="1" name="isgd" />否
							</td>
						</tr>
						<tr>
							...
							<td width="80%" height="35" bgcolor="#F1F9FD">&nbsp; <input
								name="content3" id="content3" style="width: 200px" /> <input
								type="radio" value="0" name="threegd" checked="checked" />否&nbsp;
								<input type="radio" value="1" name="threegd" />是
							</td>
						</tr>
						<tr>
							<td width="20%" height="35" bgcolor="#FFFFFF"
							...
							<td width="80%" height="35" bgcolor="#F1F9FD">&nbsp; <input
								name="content4" id="content4" style="width: 200px" /> <input
								type="radio" value="0" name="fourgd" checked="checked" />否&nbsp;
								<input type="radio" value="1" name="fourgd" />是
							</td>
						</tr>
					</table>
				</form> <input name="bt1" class="button" type="button" value=" 添加 "
				onClick="addQueue(1)" /> <input name="bt2" class="button"
