...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="/queue/window/js/tv_queue_led_zhuhai_xisuo.js"></script>
	...
	<body scroll="no" >
		<div class="inner tv" name="top_u1" id="top_u1" style="margin-left:0px;position:absolute;left:0;top:0;background:#000;">
			<table id="tab1" class ="tab1">
				<tr>
					<td colspan="3" rowspan="1" class="td11" style="font-size: 20px">各业务等待人数</td>
				<!--  	<td colspan="1" rowspan="1" class="td11">排队信息</td>-->
					<td colspan="1" rowspan="2" class="td11" style="font-size: 28px">排队信息</td>
					<td colspan="3" rowspan="1" class="td11">各窗口业务办理信息</td>
				</tr>
				<tr>
					<td colspan="1" rowspan="1" class="td12" style="width: 15%">业务名称</td>
					<td colspan="1" rowspan="1" class="td12" style="width: 8%">待办量</td>
					<td colspan="1" rowspan="1" class="td12" style="width: 8%">预叫号</td>

					
					<td colspan="1" rowspan="1" class="td12" style="width: 8%">窗口号</td>
					<td colspan="1" rowspan="1" class="td12" style="width: 8%">完成量</td>
				...
				<tr>
					...
					<td colspan="1" rowspan="1" style="width: 29%;vertical-align:top;">
