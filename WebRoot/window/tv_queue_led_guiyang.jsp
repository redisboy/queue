...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="/queue/window/js/tv_queue_led_guiyang.js"></script>
	...
	<body scroll="no">
		<div class="inner tv" name="top_u1" id="top_u1" style="position:absolute;left:0;top:0;background:#000;">
			<table id="tab1" class="tab1">
				...
				<tr>
					<td class="border_b td1" colspan="2"><marquee id="gdxx" scrollamount="2" style="font-size:22px;color:yellow"></marquee></td>
					<td id="nowDate" class="border_b td1" style="font-size:22px"></td>
				</tr>
				<tr>
					<td id="title1" class="border_b td1" style="width:36%;font-size:22px"></td>
					<td id="title2" class="border_b td1" style="width:28%;font-size:22px"></td>
