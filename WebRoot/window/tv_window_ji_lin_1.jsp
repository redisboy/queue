...
li {list-style:none;}
	.ul_1 li{
	height:110px;line-height:130px;
	border-bottom: none;
}
</style>
		...
		<script type="text/javascript" src="/queue/window/js/tv_window_ji_lin_1.js"></script>
	...
	<body scroll="no" onload="onload()">
		...
		<div class="inner tv" name="top_u1" id="top_u1" style="display:none;position:relative;background:#ffffff;">
			<ul class="ul_1" name="date_u1" id="date_u1" style="left:10px;top:0;color:#0000ff;" ></ul>
		</div>
